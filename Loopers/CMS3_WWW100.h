...
// makeCMS3ClassFiles("/hadoop/cms/store/user/bhashemi/AutoTwopler_babies/merged/VVV/WWW_v0.1.18/skim/www_2l_mia_skim_1.root", "t", "CMS3", "tas", "cms3")
...
class CMS3 {
 ...
 protected: 
  ...
  vector<float> *lep_bdt1_;
  TBranch *lep_bdt1_branch;
  bool     lep_bdt1_isLoaded;
  vector<float> *lep_bdt2_;
  TBranch *lep_bdt2_branch;
  bool     lep_bdt2_isLoaded;
  vector<float> *lep_bdt3_;
  TBranch *lep_bdt3_branch;
  bool     lep_bdt3_isLoaded;
  vector<int> *lep_3ch_agree_;
  ...
  vector<int> *lep_isTriggerSafe_v2_;
  TBranch *lep_isTriggerSafe_v2_branch;
  bool     lep_isTriggerSafe_v2_isLoaded;
  vector<int> *lep_pass_POG_loose_noiso_;
  TBranch *lep_pass_POG_loose_noiso_branch;
  bool     lep_pass_POG_loose_noiso_isLoaded;
  vector<int> *lep_pass_POG_medium_noiso_;
  TBranch *lep_pass_POG_medium_noiso_branch;
  bool     lep_pass_POG_medium_noiso_isLoaded;
  vector<int> *lep_pass_POG_tight_noiso_;
  TBranch *lep_pass_POG_tight_noiso_branch;
  bool     lep_pass_POG_tight_noiso_isLoaded;
  ...
  vector<float> *lep_exp_innerlayers_;
  TBranch *lep_exp_innerlayers_branch;
  bool     lep_exp_innerlayers_isLoaded;
  vector<float> *lep_exp_outerlayers_;
  TBranch *lep_exp_outerlayers_branch;
  bool     lep_exp_outerlayers_isLoaded;
  vector<int> *lep_nlayers_;
  TBranch *lep_nlayers_branch;
  bool     lep_nlayers_isLoaded;
  vector<int> *lep_type_;
  TBranch *lep_type_branch;
  bool     lep_type_isLoaded;
  vector<int> *lep_validHits_;
  TBranch *lep_validHits_branch;
  bool     lep_validHits_isLoaded;
  vector<float> *lep_dEtaIn_e_;
  TBranch *lep_dEtaIn_e_branch;
  bool     lep_dEtaIn_e_isLoaded;
  vector<float> *lep_dEtaOut_e_;
  TBranch *lep_dEtaOut_e_branch;
  bool     lep_dEtaOut_e_isLoaded;
  vector<float> *lep_dPhiIn_e_;
  TBranch *lep_dPhiIn_e_branch;
  bool     lep_dPhiIn_e_isLoaded;
  vector<float> *lep_ecalEnergy_e_;
  TBranch *lep_ecalEnergy_e_branch;
  bool     lep_ecalEnergy_e_isLoaded;
  vector<float> *lep_ecalEnergyError_e_;
  TBranch *lep_ecalEnergyError_e_branch;
  bool     lep_ecalEnergyError_e_isLoaded;
  vector<float> *lep_ecalPFClusterIso_e_;
  TBranch *lep_ecalPFClusterIso_e_branch;
  bool     lep_ecalPFClusterIso_e_isLoaded;
  vector<float> *lep_eOverPIn_e_;
  TBranch *lep_eOverPIn_e_branch;
  bool     lep_eOverPIn_e_isLoaded;
  vector<float> *lep_hcalPFClusterIso_e_;
  TBranch *lep_hcalPFClusterIso_e_branch;
  bool     lep_hcalPFClusterIso_e_isLoaded;
  vector<float> *lep_hOverE_e_;
  TBranch *lep_hOverE_e_branch;
  bool     lep_hOverE_e_isLoaded;
  vector<float> *lep_scSeedEta_e_;
  TBranch *lep_scSeedEta_e_branch;
  bool     lep_scSeedEta_e_isLoaded;
  vector<float> *lep_sigmaIEtaIEta_full5x5_e_;
  TBranch *lep_sigmaIEtaIEta_full5x5_e_branch;
  bool     lep_sigmaIEtaIEta_full5x5_e_isLoaded;
  vector<float> *lep_tkIso_e_;
  TBranch *lep_tkIso_e_branch;
  bool     lep_tkIso_e_isLoaded;
  vector<int> *lep_goodGlb_m_;
  TBranch *lep_goodGlb_m_branch;
  bool     lep_goodGlb_m_isLoaded;
  vector<int> *lep_isGlobal_m_;
  TBranch *lep_isGlobal_m_branch;
  bool     lep_isGlobal_m_isLoaded;
  vector<int> *lep_isTracker_m_;
  TBranch *lep_isTracker_m_branch;
  bool     lep_isTracker_m_isLoaded;
  vector<int> *lep_gfit_ndof_m_;
  TBranch *lep_gfit_ndof_m_branch;
  bool     lep_gfit_ndof_m_isLoaded;
  vector<float> *lep_chi2LocalPosition_m_;
  TBranch *lep_chi2LocalPosition_m_branch;
  bool     lep_chi2LocalPosition_m_isLoaded;
  vector<float> *lep_gfit_chi2_m_;
  TBranch *lep_gfit_chi2_m_branch;
  bool     lep_gfit_chi2_m_isLoaded;
  vector<int> *lep_gfit_validSTAHits_m_;
  TBranch *lep_gfit_validSTAHits_m_branch;
  bool     lep_gfit_validSTAHits_m_isLoaded;
  vector<int> *lep_numberOfMatchedStations_m_;
  TBranch *lep_numberOfMatchedStations_m_branch;
  bool     lep_numberOfMatchedStations_m_isLoaded;
  vector<int> *lep_pid_PFMuon_m_;
  TBranch *lep_pid_PFMuon_m_branch;
  bool     lep_pid_PFMuon_m_isLoaded;
  vector<float> *lep_segmCompatibility_m_;
  TBranch *lep_segmCompatibility_m_branch;
  bool     lep_segmCompatibility_m_isLoaded;
  vector<float> *lep_trkKink_m_;
  TBranch *lep_trkKink_m_branch;
  bool     lep_trkKink_m_isLoaded;
  vector<int> *lep_validPixelHits_m_;
  TBranch *lep_validPixelHits_m_branch;
  bool     lep_validPixelHits_m_isLoaded;
  int      nisoTrack_5gev_;
  ...
  vector<int> *genPart_isp6status3_;
  ...
  vector<int> *genLep_isp6status3_;
...
void LoadAllBranches(); 
  ...
  const vector<float> &lep_bdt1();
  const vector<float> &lep_bdt2();
  const vector<float> &lep_bdt3();
  const vector<int> &lep_3ch_agree();
  ...
  const vector<int> &lep_isTriggerSafenoIso_v1();
  const vector<int> &lep_isTriggerSafenoIso_v2();
  const vector<int> &lep_isTriggerSafe_v1();
  const vector<int> &lep_isTriggerSafe_v2();
  const vector<int> &lep_pass_POG_loose_noiso();
  const vector<int> &lep_pass_POG_medium_noiso();
  const vector<int> &lep_pass_POG_tight_noiso();
  const vector<int> &lep_pass_VVV_cutbased_veto();
  const vector<int> &lep_pass_VVV_cutbased_veto_noiso();
  const vector<int> &lep_pass_VVV_cutbased_veto_noiso_noip();
  const vector<int> &lep_pass_VVV_cutbased_veto_bak1();
  const vector<int> &lep_pass_VVV_cutbased_veto_noiso_bak1();
  const vector<int> &lep_pass_VVV_cutbased_veto_noiso_noip_bak1();
  ...
  const vector<int> &lep_pass_VVV_MVAbased_tight_noiso();
  const vector<int> &lep_pass_VVV_MVAbased_tight();
  const vector<int> &lep_pass_VVV_baseline();
  ...
  const vector<float> &lep_exp_innerlayers();
  const vector<float> &lep_exp_outerlayers();
  const vector<int> &lep_nlayers();
  const vector<int> &lep_type();
  const vector<int> &lep_validHits();
  const vector<float> &lep_dEtaIn_e();
  const vector<float> &lep_dEtaOut_e();
  const vector<float> &lep_dPhiIn_e();
  const vector<float> &lep_ecalEnergy_e();
  const vector<float> &lep_ecalEnergyError_e();
  const vector<float> &lep_ecalPFClusterIso_e();
  const vector<float> &lep_eOverPIn_e();
  const vector<float> &lep_hcalPFClusterIso_e();
  const vector<float> &lep_hOverE_e();
  const vector<float> &lep_scSeedEta_e();
  const vector<float> &lep_sigmaIEtaIEta_full5x5_e();
  const vector<float> &lep_tkIso_e();
  const vector<int> &lep_goodGlb_m();
  const vector<int> &lep_isGlobal_m();
  const vector<int> &lep_isTracker_m();
  const vector<int> &lep_gfit_ndof_m();
  const vector<float> &lep_chi2LocalPosition_m();
  const vector<float> &lep_gfit_chi2_m();
  const vector<int> &lep_gfit_validSTAHits_m();
  const vector<int> &lep_numberOfMatchedStations_m();
  const vector<int> &lep_pid_PFMuon_m();
  const vector<float> &lep_segmCompatibility_m();
  const vector<float> &lep_trkKink_m();
  const vector<int> &lep_validPixelHits_m();
  ...
  const vector<int> &genPart_isp6status3();
  const int &ngenLep();
  ...
  const vector<int> &genLep_isp6status3();
  const int &ngenTau();
