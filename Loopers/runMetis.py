...
while True:
    ...
    total_summary["WWW_v0_1_18"] = task.get_task_summary()
...
os.system("./rename \<\(sh map.sh ProjectMetis/tasks/CondorTask_WWW_v0_1_18_minibaby_v18/logs/std_logs/ | grep hadoop\) /hadoop/cms/store/user/phchang/metis/wwwanalysis/WWW_v0_1_{}_{}/".format(input_tag, job_tag))
os.system("sh merge.sh /hadoop/cms/store/user/phchang/metis/wwwanalysis/WWW_v0_1_{}_{}/".format(input_tag, job_tag))
