...
void CMS3::Init(TTree *tree) {
  ...
  tree->SetMakeClass(1);
	...
	lep_pass_POG_loose_noiso_branch = 0;
	if (tree->GetBranch("lep_pass_POG_loose_noiso") != 0) {
	...
	lep_pass_POG_medium_noiso_branch = 0;
	if (tree->GetBranch("lep_pass_POG_medium_noiso") != 0) {
	...
	lep_pass_POG_tight_noiso_branch = 0;
	if (tree->GetBranch("lep_pass_POG_tight_noiso") != 0) {
	...
	lep_trk_pt_branch = 0;
	if (tree->GetBranch("lep_trk_pt") != 0) {
	...
	weight_fr_r1_f1_branch = 0;
	if (tree->GetBranch("weight_fr_r1_f1") != 0) {
	...
	weight_fr_r1_f2_branch = 0;
	if (tree->GetBranch("weight_fr_r1_f2") != 0) {
	...
	weight_fr_r1_f0p5_branch = 0;
	if (tree->GetBranch("weight_fr_r1_f0p5") != 0) {
	...
	weight_fr_r2_f1_branch = 0;
	if (tree->GetBranch("weight_fr_r2_f1") != 0) {
	...
	weight_fr_r2_f2_branch = 0;
	if (tree->GetBranch("weight_fr_r2_f2") != 0) {
	...
	weight_fr_r2_f0p5_branch = 0;
	if (tree->GetBranch("weight_fr_r2_f0p5") != 0) {
	...
	weight_fr_r0p5_f1_branch = 0;
	if (tree->GetBranch("weight_fr_r0p5_f1") != 0) {
	...
	weight_fr_r0p5_f2_branch = 0;
	if (tree->GetBranch("weight_fr_r0p5_f2") != 0) {
	...
	weight_fr_r0p5_f0p5_branch = 0;
	if (tree->GetBranch("weight_fr_r0p5_f0p5") != 0) {
