void makePlotsProcessSRplotBtag(){
    ...
    histonames.push_back("SRyield");   axisnames.push_back("Yields in validation region for fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(0);
