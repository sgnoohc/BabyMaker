void makePlotsProcessBtag(){
    ...
    histonames.push_back("MET_SRSS_btag");   axisnames.push_back("E_{T}^{miss} [GeV] | validation of fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(1);
   // histonames.push_back("njets_SRSS_btag");   axisnames.push_back("Number of jets | validation of fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(1);
   // histonames.push_back("nbjets_SRSS_btag");   axisnames.push_back("N_{B}^{med} | validation of fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(1);
    histonames.push_back("pTl1_SRSS_btag");   axisnames.push_back("Leading lepton p_{T} [GeV] | validation of fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(1);
    histonames.push_back("Mjj_SRSS_btag");   axisnames.push_back("M_{jj} [GeV] | validation of fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(1);
    histonames.push_back("pTl2_SRSS_btag");   axisnames.push_back("Subleading lepton p_{T} [GeV] | validation of fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(1);
    histonames.push_back("Mll_SRSS_btag");   axisnames.push_back("M_{ll} [GeV] | validation of fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(1);
    histonames.push_back("MTmax_SRSS_btag");   axisnames.push_back("M_{T}^{max} [GeV] | validation of fake rate method, N_{B}^{med}#geq1");  onlySSSFOS.push_back(1);
    /*
...
*/
	...
	if(s==nsig){
	  //h[bgname]->SetFillColor(cols[samples.size()-1]); h[bgname]->SetLineColor(cols[samples.size()-1]); h[bgname]->SetFillStyle(3004);
