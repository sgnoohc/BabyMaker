...
const vector<bool> &CMS3::lep_3ch_agree() {
...
const vector<bool> &CMS3::lep_isFromW() {
...
const vector<bool> &CMS3::lep_isFromZ() {
...
const vector<bool> &CMS3::lep_isFromB() {
...
const vector<bool> &CMS3::lep_isFromC() {
...
const vector<bool> &CMS3::lep_isFromL() {
...
const vector<bool> &CMS3::lep_isFromLF() {
...
const vector<double> &CMS3::lep_ptRatio() {
...
const vector<double> &CMS3::lep_coneCorrPt() {
...
const vector<double> &CMS3::lep_ptRel() {
...
const vector<double> &CMS3::lep_relIso03() {
...
const vector<double> &CMS3::lep_relIso03DB() {
...
const vector<double> &CMS3::lep_relIso03EA() {
...
const vector<double> &CMS3::lep_relIso03EAv2() {
...
const vector<double> &CMS3::lep_relIso04DB() {
...
const vector<double> &CMS3::lep_relIso04EA() {
...
const vector<double> &CMS3::lep_relIso04EAv2() {
...
const vector<double> &CMS3::lep_miniRelIsoCMS3_EA() {
...
const vector<double> &CMS3::lep_miniRelIsoCMS3_EAv2() {
...
const vector<double> &CMS3::lep_miniRelIsoCMS3_DB() {
...
const vector<bool> &CMS3::lep_isTriggerSafenoIso_v1() {
...
const vector<bool> &CMS3::lep_isTriggerSafenoIso_v2() {
...
const vector<bool> &CMS3::lep_isTriggerSafe_v1() {
...
const vector<bool> &CMS3::lep_isTriggerSafe_v2() {
...
const vector<bool> &CMS3::lep_pass_POG_loose_noiso() {
...
const vector<bool> &CMS3::lep_pass_POG_medium_noiso() {
...
const vector<bool> &CMS3::lep_pass_POG_tight_noiso() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_veto() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_veto_noiso() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_veto_noiso_noip() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_veto_bak1() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_veto_noiso_bak1() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_veto_noiso_noip_bak1() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_fo() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_fo_noiso() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_tight_noiso() {
...
const vector<bool> &CMS3::lep_pass_VVV_cutbased_tight() {
...
const vector<bool> &CMS3::lep_pass_VVV_MVAbased_tight_noiso() {
...
const vector<bool> &CMS3::lep_pass_VVV_MVAbased_tight() {
...
const vector<bool> &CMS3::lep_pass_VVV_baseline() {
...
const vector<bool> &CMS3::lep_goodGlb_m() {
...
const vector<bool> &CMS3::lep_isGlobal_m() {
...
const vector<bool> &CMS3::lep_isTracker_m() {
...
const vector<float> &CMS3::genPart_charge() {
...
const vector<bool> &CMS3::genPart_isp6status3() {
...
const vector<bool> &CMS3::genLep_isp6status3() {
...
const double &CMS3::weight_fr_r1_f1() {
...
const double &CMS3::weight_fr_r1_f2() {
...
const double &CMS3::weight_fr_r1_f0p5() {
...
const double &CMS3::weight_fr_r2_f1() {
...
const double &CMS3::weight_fr_r2_f2() {
...
const double &CMS3::weight_fr_r2_f0p5() {
...
const double &CMS3::weight_fr_r0p5_f1() {
...
const double &CMS3::weight_fr_r0p5_f2() {
...
const double &CMS3::weight_fr_r0p5_f0p5() {
...
const double &CMS3::weight_pdf_up() {
...
const double &CMS3::weight_pdf_down() {
...
const double &CMS3::weight_alphas_down() {
...
const double &CMS3::weight_alphas_up() {
...
const vector<bool> &lep_3ch_agree() { return cms3.lep_3ch_agree(); }
const vector<bool> &lep_isFromW() { return cms3.lep_isFromW(); }
const vector<bool> &lep_isFromZ() { return cms3.lep_isFromZ(); }
const vector<bool> &lep_isFromB() { return cms3.lep_isFromB(); }
const vector<bool> &lep_isFromC() { return cms3.lep_isFromC(); }
const vector<bool> &lep_isFromL() { return cms3.lep_isFromL(); }
const vector<bool> &lep_isFromLF() { return cms3.lep_isFromLF(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &lep_closest_jet_p4() { return cms3.lep_closest_jet_p4(); }
const vector<double> &lep_ptRatio() { return cms3.lep_ptRatio(); }
...
const vector<double> &lep_coneCorrPt() { return cms3.lep_coneCorrPt(); }
const vector<double> &lep_ptRel() { return cms3.lep_ptRel(); }
const vector<double> &lep_relIso03() { return cms3.lep_relIso03(); }
const vector<double> &lep_relIso03DB() { return cms3.lep_relIso03DB(); }
const vector<double> &lep_relIso03EA() { return cms3.lep_relIso03EA(); }
const vector<double> &lep_relIso03EAv2() { return cms3.lep_relIso03EAv2(); }
const vector<double> &lep_relIso04DB() { return cms3.lep_relIso04DB(); }
const vector<double> &lep_relIso04EA() { return cms3.lep_relIso04EA(); }
const vector<double> &lep_relIso04EAv2() { return cms3.lep_relIso04EAv2(); }
const vector<double> &lep_miniRelIsoCMS3_EA() { return cms3.lep_miniRelIsoCMS3_EA(); }
const vector<double> &lep_miniRelIsoCMS3_EAv2() { return cms3.lep_miniRelIsoCMS3_EAv2(); }
const vector<double> &lep_miniRelIsoCMS3_DB() { return cms3.lep_miniRelIsoCMS3_DB(); }
const vector<bool> &lep_isTriggerSafenoIso_v1() { return cms3.lep_isTriggerSafenoIso_v1(); }
const vector<bool> &lep_isTriggerSafenoIso_v2() { return cms3.lep_isTriggerSafenoIso_v2(); }
const vector<bool> &lep_isTriggerSafe_v1() { return cms3.lep_isTriggerSafe_v1(); }
const vector<bool> &lep_isTriggerSafe_v2() { return cms3.lep_isTriggerSafe_v2(); }
const vector<bool> &lep_pass_POG_loose_noiso() { return cms3.lep_pass_POG_loose_noiso(); }
const vector<bool> &lep_pass_POG_medium_noiso() { return cms3.lep_pass_POG_medium_noiso(); }
const vector<bool> &lep_pass_POG_tight_noiso() { return cms3.lep_pass_POG_tight_noiso(); }
const vector<bool> &lep_pass_VVV_cutbased_veto() { return cms3.lep_pass_VVV_cutbased_veto(); }
const vector<bool> &lep_pass_VVV_cutbased_veto_noiso() { return cms3.lep_pass_VVV_cutbased_veto_noiso(); }
const vector<bool> &lep_pass_VVV_cutbased_veto_noiso_noip() { return cms3.lep_pass_VVV_cutbased_veto_noiso_noip(); }
const vector<bool> &lep_pass_VVV_cutbased_veto_bak1() { return cms3.lep_pass_VVV_cutbased_veto_bak1(); }
const vector<bool> &lep_pass_VVV_cutbased_veto_noiso_bak1() { return cms3.lep_pass_VVV_cutbased_veto_noiso_bak1(); }
const vector<bool> &lep_pass_VVV_cutbased_veto_noiso_noip_bak1() { return cms3.lep_pass_VVV_cutbased_veto_noiso_noip_bak1(); }
const vector<bool> &lep_pass_VVV_cutbased_fo() { return cms3.lep_pass_VVV_cutbased_fo(); }
const vector<bool> &lep_pass_VVV_cutbased_fo_noiso() { return cms3.lep_pass_VVV_cutbased_fo_noiso(); }
const vector<bool> &lep_pass_VVV_cutbased_tight_noiso() { return cms3.lep_pass_VVV_cutbased_tight_noiso(); }
const vector<bool> &lep_pass_VVV_cutbased_tight() { return cms3.lep_pass_VVV_cutbased_tight(); }
const vector<bool> &lep_pass_VVV_MVAbased_tight_noiso() { return cms3.lep_pass_VVV_MVAbased_tight_noiso(); }
const vector<bool> &lep_pass_VVV_MVAbased_tight() { return cms3.lep_pass_VVV_MVAbased_tight(); }
const vector<bool> &lep_pass_VVV_baseline() { return cms3.lep_pass_VVV_baseline(); }
...
const vector<bool> &lep_goodGlb_m() { return cms3.lep_goodGlb_m(); }
const vector<bool> &lep_isGlobal_m() { return cms3.lep_isGlobal_m(); }
const vector<bool> &lep_isTracker_m() { return cms3.lep_isTracker_m(); }
...
const double &weight_fr_r1_f1() { return cms3.weight_fr_r1_f1(); }
const double &weight_fr_r1_f2() { return cms3.weight_fr_r1_f2(); }
const double &weight_fr_r1_f0p5() { return cms3.weight_fr_r1_f0p5(); }
const double &weight_fr_r2_f1() { return cms3.weight_fr_r2_f1(); }
const double &weight_fr_r2_f2() { return cms3.weight_fr_r2_f2(); }
const double &weight_fr_r2_f0p5() { return cms3.weight_fr_r2_f0p5(); }
const double &weight_fr_r0p5_f1() { return cms3.weight_fr_r0p5_f1(); }
const double &weight_fr_r0p5_f2() { return cms3.weight_fr_r0p5_f2(); }
const double &weight_fr_r0p5_f0p5() { return cms3.weight_fr_r0p5_f0p5(); }
const double &weight_pdf_up() { return cms3.weight_pdf_up(); }
const double &weight_pdf_down() { return cms3.weight_pdf_down(); }
const double &weight_alphas_down() { return cms3.weight_alphas_down(); }
const double &weight_alphas_up() { return cms3.weight_alphas_up(); }
