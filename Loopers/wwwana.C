...
bool WWWAnalysis::calcStdVariables()
{
    ...
    else if (lepton_version == 3)
        getleptonindices_v2(list_tight_ss_lep_idx, list_tight_3l_lep_idx, list_loose_ss_lep_idx, list_loose_3l_lep_idx, list_veto_ss_lep_idx, list_veto_3l_lep_idx, list_looseveto_ss_lep_idx, list_looseveto_3l_lep_idx);
