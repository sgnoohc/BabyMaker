...
// makeCMS3ClassFiles("/hadoop/cms/store/user/bhashemi/AutoTwopler_babies/merged/VVV/WWW_v0.1.17/skim/www_2l_mia_skim_1.root", "t", "CMS3", "tas", "cms3")
...
// makeCMS3ClassFiles("chain files", "t", "CMS3", "tas", "cms3")
