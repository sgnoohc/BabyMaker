...
void CMS3::Init(TTree *tree) {
  ...
  w0_p4_branch = tree->GetBranch("w0_p4");
  if (w0_p4_branch) w0_p4_branch->SetAddress(&w0_p4_);
  w1_p4_branch = tree->GetBranch("w1_p4");
  if (w1_p4_branch) w1_p4_branch->SetAddress(&w1_p4_);
  l0_p4_branch = tree->GetBranch("l0_p4");
  if (l0_p4_branch) l0_p4_branch->SetAddress(&l0_p4_);
  l1_p4_branch = tree->GetBranch("l1_p4");
  if (l1_p4_branch) l1_p4_branch->SetAddress(&l1_p4_);
  v0_p4_branch = tree->GetBranch("v0_p4");
  if (v0_p4_branch) v0_p4_branch->SetAddress(&v0_p4_);
  v1_p4_branch = tree->GetBranch("v1_p4");
  if (v1_p4_branch) v1_p4_branch->SetAddress(&v1_p4_);
  ...
  iswhchannel_branch = tree->GetBranch("iswhchannel");
  if (iswhchannel_branch) iswhchannel_branch->SetAddress(&iswhchannel_);
...
void CMS3::GetEntry(unsigned int idx) {
  ...
  iswhchannel_isLoaded = false;
  w_p4_isLoaded = false;
  q0_p4_isLoaded = false;
  q1_p4_isLoaded = false;
  h_p4_isLoaded = false;
  w0_p4_isLoaded = false;
  w1_p4_isLoaded = false;
  l0_p4_isLoaded = false;
  l1_p4_isLoaded = false;
  v0_p4_isLoaded = false;
  v1_p4_isLoaded = false;
}
...
void CMS3::LoadAllBranches() {
  ...
  if (iswhchannel_branch != 0) iswhchannel();
  if (w_p4_branch != 0) w_p4();
  if (q0_p4_branch != 0) q0_p4();
  if (q1_p4_branch != 0) q1_p4();
  if (h_p4_branch != 0) h_p4();
  if (w0_p4_branch != 0) w0_p4();
  if (w1_p4_branch != 0) w1_p4();
  if (l0_p4_branch != 0) l0_p4();
  if (l1_p4_branch != 0) l1_p4();
  if (v0_p4_branch != 0) v0_p4();
  if (v1_p4_branch != 0) v1_p4();
}
...
const int &CMS3::HLT_SingleIsoEl8() {
...
const int &CMS3::HLT_SingleIsoEl17() {
...
const int &CMS3::HLT_SingleIsoMu8() {
...
const int &CMS3::HLT_SingleIsoMu17() {
...
const int &CMS3::mc_HLT_SingleIsoEl8() {
...
const int &CMS3::mc_HLT_SingleIsoEl17() {
...
const int &CMS3::mc_HLT_SingleIsoMu8() {
...
const int &CMS3::mc_HLT_SingleIsoMu17() {
...
const vector<float> &CMS3::lep_relIso03EAv2Lep() {
...
const vector<int> &CMS3::lep_isMediumPOG() {
...
const vector<int> &CMS3::lep_isTightPOG() {
...
const float &CMS3::ffwgt_closure_up() {
...
const float &CMS3::ffwgt_closure_dn() {
...
const float &CMS3::ffwgt_closure_el_up() {
...
const float &CMS3::ffwgt_closure_el_dn() {
...
const float &CMS3::ffwgt_closure_mu_up() {
...
const float &CMS3::ffwgt_closure_mu_dn() {
...
const float &CMS3::ffwgt_full_up() {
...
const float &CMS3::ffwgt_full_dn() {
...
const int &CMS3::iswhchannel() {
  if (not iswhchannel_isLoaded) {
    if (iswhchannel_branch != 0) {
      iswhchannel_branch->GetEntry(index);
    } else {
      printf("branch iswhchannel_branch does not exist!\n");
      exit(1);
    }
    iswhchannel_isLoaded = true;
  }
  return iswhchannel_;
}

const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::w_p4() {
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::q0_p4() {
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::q1_p4() {
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::h_p4() {
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::w0_p4() {
  if (not w0_p4_isLoaded) {
    if (w0_p4_branch != 0) {
      w0_p4_branch->GetEntry(index);
    } else {
      printf("branch w0_p4_branch does not exist!\n");
      exit(1);
    }
    w0_p4_isLoaded = true;
  }
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::w1_p4() {
  if (not w1_p4_isLoaded) {
    if (w1_p4_branch != 0) {
      w1_p4_branch->GetEntry(index);
    } else {
      printf("branch w1_p4_branch does not exist!\n");
      exit(1);
    }
    w1_p4_isLoaded = true;
  }
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::l0_p4() {
  if (not l0_p4_isLoaded) {
    if (l0_p4_branch != 0) {
      l0_p4_branch->GetEntry(index);
    } else {
      printf("branch l0_p4_branch does not exist!\n");
      exit(1);
    }
    l0_p4_isLoaded = true;
  }
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::l1_p4() {
  if (not l1_p4_isLoaded) {
    if (l1_p4_branch != 0) {
      l1_p4_branch->GetEntry(index);
    } else {
      printf("branch l1_p4_branch does not exist!\n");
      exit(1);
    }
    l1_p4_isLoaded = true;
  }
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::v0_p4() {
  if (not v0_p4_isLoaded) {
    if (v0_p4_branch != 0) {
      v0_p4_branch->GetEntry(index);
    } else {
      printf("branch v0_p4_branch does not exist!\n");
      exit(1);
    }
    v0_p4_isLoaded = true;
  }
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::v1_p4() {
  if (not v1_p4_isLoaded) {
    if (v1_p4_branch != 0) {
      v1_p4_branch->GetEntry(index);
    } else {
      printf("branch v1_p4_branch does not exist!\n");
      exit(1);
    }
    v1_p4_isLoaded = true;
  }
...
const int &HLT_SingleIsoEl8() { return cms3.HLT_SingleIsoEl8(); }
const int &HLT_SingleIsoEl17() { return cms3.HLT_SingleIsoEl17(); }
const int &HLT_SingleIsoMu8() { return cms3.HLT_SingleIsoMu8(); }
const int &HLT_SingleIsoMu17() { return cms3.HLT_SingleIsoMu17(); }
...
const int &mc_HLT_SingleIsoEl8() { return cms3.mc_HLT_SingleIsoEl8(); }
const int &mc_HLT_SingleIsoEl17() { return cms3.mc_HLT_SingleIsoEl17(); }
const int &mc_HLT_SingleIsoMu8() { return cms3.mc_HLT_SingleIsoMu8(); }
const int &mc_HLT_SingleIsoMu17() { return cms3.mc_HLT_SingleIsoMu17(); }
...
const vector<float> &lep_relIso03EAv2Lep() { return cms3.lep_relIso03EAv2Lep(); }
...
const vector<int> &lep_isMediumPOG() { return cms3.lep_isMediumPOG(); }
const vector<int> &lep_isTightPOG() { return cms3.lep_isTightPOG(); }
...
const float &MTmax3L() { return cms3.MTmax3L(); }
const float &MTmax3L_up() { return cms3.MTmax3L_up(); }
const float &MTmax3L_dn() { return cms3.MTmax3L_dn(); }
...
const float &ffwgt_el_up() { return cms3.ffwgt_el_up(); }
const float &ffwgt_el_dn() { return cms3.ffwgt_el_dn(); }
const float &ffwgt_mu_up() { return cms3.ffwgt_mu_up(); }
const float &ffwgt_mu_dn() { return cms3.ffwgt_mu_dn(); }
const float &ffwgt_closure_up() { return cms3.ffwgt_closure_up(); }
const float &ffwgt_closure_dn() { return cms3.ffwgt_closure_dn(); }
const float &ffwgt_closure_el_up() { return cms3.ffwgt_closure_el_up(); }
const float &ffwgt_closure_el_dn() { return cms3.ffwgt_closure_el_dn(); }
const float &ffwgt_closure_mu_up() { return cms3.ffwgt_closure_mu_up(); }
const float &ffwgt_closure_mu_dn() { return cms3.ffwgt_closure_mu_dn(); }
const float &ffwgt_full_up() { return cms3.ffwgt_full_up(); }
const float &ffwgt_full_dn() { return cms3.ffwgt_full_dn(); }
...
const float &trigsf() { return cms3.trigsf(); }
const float &trigsf_up() { return cms3.trigsf_up(); }
const float &trigsf_dn() { return cms3.trigsf_dn(); }
...
const int &iswhchannel() { return cms3.iswhchannel(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &w_p4() { return cms3.w_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &q0_p4() { return cms3.q0_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &q1_p4() { return cms3.q1_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &h_p4() { return cms3.h_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &w0_p4() { return cms3.w0_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &w1_p4() { return cms3.w1_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &l0_p4() { return cms3.l0_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &l1_p4() { return cms3.l1_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &v0_p4() { return cms3.v0_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &v1_p4() { return cms3.v1_p4(); }
