...
def addProcesses(printer, showdata):
    ...
    printer.addCutflowProcess("/sig/www", "WWW")
    printer.addCutflowProcess("|", "|")
    ...
    printer.addCutflowProcess("/bkg/VV/WZ", "WZ")
    ...
    printer.addCutflowProcess("|", "|")
    printer.addCutflowProcess("/typebkg", "Tot. type")
    printer.addCutflowProcess("|", "|")
    printer.addCutflowProcess("/fake", "d.d. fake")
    printer.addCutflowProcess("|", "|")
    printer.addCutflowProcess("/fake+typebkg-typebkg/fakes", "Tot. B")
    printer.addCutflowProcess("|", "|")
    printer.addCutflowProcess("$signif(/sig,/bkg)", "Sig. MC")
    printer.addCutflowProcess("|", "|")
    printer.addCutflowProcess("$signif(/sig,/fake+typebkg-typebkg/fakes)", "Sig.")
    if showdata:
        printer.addCutflowProcess("|", "|")
