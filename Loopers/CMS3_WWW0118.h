...
void LoadAllBranches(); 
  ...
  const vector<bool> &lep_pass_POG_loose_noiso();
  const vector<bool> &lep_pass_POG_medium_noiso();
  const vector<bool> &lep_pass_POG_tight_noiso();
  ...
  const vector<bool> &lep_goodGlb_m();
  const vector<bool> &lep_isGlobal_m();
  const vector<bool> &lep_isTracker_m();
  ...
  const double &weight_fr_r1_f1();
  const double &weight_fr_r1_f2();
  const double &weight_fr_r1_f0p5();
  const double &weight_fr_r2_f1();
  const double &weight_fr_r2_f2();
  const double &weight_fr_r2_f0p5();
  const double &weight_fr_r0p5_f1();
  const double &weight_fr_r0p5_f2();
  const double &weight_fr_r0p5_f0p5();
