...
void CMS3::Init(TTree *tree) {
  ...
  evt_fixgridfastjet_allcalo_rho_branch = tree->GetBranch("evt_fixgridfastjet_allcalo_rho");
  ...
  lep_bdt1_branch = tree->GetBranch("lep_bdt1");
  if (lep_bdt1_branch) lep_bdt1_branch->SetAddress(&lep_bdt1_);
  lep_bdt2_branch = tree->GetBranch("lep_bdt2");
  if (lep_bdt2_branch) lep_bdt2_branch->SetAddress(&lep_bdt2_);
  lep_bdt3_branch = tree->GetBranch("lep_bdt3");
  if (lep_bdt3_branch) lep_bdt3_branch->SetAddress(&lep_bdt3_);
  ...
  lep_pass_POG_loose_noiso_branch = tree->GetBranch("lep_pass_POG_loose_noiso");
  if (lep_pass_POG_loose_noiso_branch) lep_pass_POG_loose_noiso_branch->SetAddress(&lep_pass_POG_loose_noiso_);
  lep_pass_POG_medium_noiso_branch = tree->GetBranch("lep_pass_POG_medium_noiso");
  if (lep_pass_POG_medium_noiso_branch) lep_pass_POG_medium_noiso_branch->SetAddress(&lep_pass_POG_medium_noiso_);
  lep_pass_POG_tight_noiso_branch = tree->GetBranch("lep_pass_POG_tight_noiso");
  if (lep_pass_POG_tight_noiso_branch) lep_pass_POG_tight_noiso_branch->SetAddress(&lep_pass_POG_tight_noiso_);
  ...
  lep_exp_innerlayers_branch = tree->GetBranch("lep_exp_innerlayers");
  if (lep_exp_innerlayers_branch) lep_exp_innerlayers_branch->SetAddress(&lep_exp_innerlayers_);
  lep_exp_outerlayers_branch = tree->GetBranch("lep_exp_outerlayers");
  if (lep_exp_outerlayers_branch) lep_exp_outerlayers_branch->SetAddress(&lep_exp_outerlayers_);
  ...
  lep_validHits_branch = tree->GetBranch("lep_validHits");
  if (lep_validHits_branch) lep_validHits_branch->SetAddress(&lep_validHits_);
  lep_dEtaIn_e_branch = tree->GetBranch("lep_dEtaIn_e");
  if (lep_dEtaIn_e_branch) lep_dEtaIn_e_branch->SetAddress(&lep_dEtaIn_e_);
  lep_dEtaOut_e_branch = tree->GetBranch("lep_dEtaOut_e");
  if (lep_dEtaOut_e_branch) lep_dEtaOut_e_branch->SetAddress(&lep_dEtaOut_e_);
  lep_dPhiIn_e_branch = tree->GetBranch("lep_dPhiIn_e");
  if (lep_dPhiIn_e_branch) lep_dPhiIn_e_branch->SetAddress(&lep_dPhiIn_e_);
  lep_ecalEnergy_e_branch = tree->GetBranch("lep_ecalEnergy_e");
  if (lep_ecalEnergy_e_branch) lep_ecalEnergy_e_branch->SetAddress(&lep_ecalEnergy_e_);
  lep_ecalEnergyError_e_branch = tree->GetBranch("lep_ecalEnergyError_e");
  if (lep_ecalEnergyError_e_branch) lep_ecalEnergyError_e_branch->SetAddress(&lep_ecalEnergyError_e_);
  lep_ecalPFClusterIso_e_branch = tree->GetBranch("lep_ecalPFClusterIso_e");
  if (lep_ecalPFClusterIso_e_branch) lep_ecalPFClusterIso_e_branch->SetAddress(&lep_ecalPFClusterIso_e_);
  lep_eOverPIn_e_branch = tree->GetBranch("lep_eOverPIn_e");
  if (lep_eOverPIn_e_branch) lep_eOverPIn_e_branch->SetAddress(&lep_eOverPIn_e_);
  lep_hcalPFClusterIso_e_branch = tree->GetBranch("lep_hcalPFClusterIso_e");
  if (lep_hcalPFClusterIso_e_branch) lep_hcalPFClusterIso_e_branch->SetAddress(&lep_hcalPFClusterIso_e_);
  lep_hOverE_e_branch = tree->GetBranch("lep_hOverE_e");
  if (lep_hOverE_e_branch) lep_hOverE_e_branch->SetAddress(&lep_hOverE_e_);
  lep_scSeedEta_e_branch = tree->GetBranch("lep_scSeedEta_e");
  if (lep_scSeedEta_e_branch) lep_scSeedEta_e_branch->SetAddress(&lep_scSeedEta_e_);
  lep_sigmaIEtaIEta_full5x5_e_branch = tree->GetBranch("lep_sigmaIEtaIEta_full5x5_e");
  if (lep_sigmaIEtaIEta_full5x5_e_branch) lep_sigmaIEtaIEta_full5x5_e_branch->SetAddress(&lep_sigmaIEtaIEta_full5x5_e_);
  lep_tkIso_e_branch = tree->GetBranch("lep_tkIso_e");
  if (lep_tkIso_e_branch) lep_tkIso_e_branch->SetAddress(&lep_tkIso_e_);
  lep_goodGlb_m_branch = tree->GetBranch("lep_goodGlb_m");
  if (lep_goodGlb_m_branch) lep_goodGlb_m_branch->SetAddress(&lep_goodGlb_m_);
  lep_isGlobal_m_branch = tree->GetBranch("lep_isGlobal_m");
  if (lep_isGlobal_m_branch) lep_isGlobal_m_branch->SetAddress(&lep_isGlobal_m_);
  lep_isTracker_m_branch = tree->GetBranch("lep_isTracker_m");
  if (lep_isTracker_m_branch) lep_isTracker_m_branch->SetAddress(&lep_isTracker_m_);
  lep_gfit_ndof_m_branch = tree->GetBranch("lep_gfit_ndof_m");
  if (lep_gfit_ndof_m_branch) lep_gfit_ndof_m_branch->SetAddress(&lep_gfit_ndof_m_);
  lep_chi2LocalPosition_m_branch = tree->GetBranch("lep_chi2LocalPosition_m");
  if (lep_chi2LocalPosition_m_branch) lep_chi2LocalPosition_m_branch->SetAddress(&lep_chi2LocalPosition_m_);
  lep_gfit_chi2_m_branch = tree->GetBranch("lep_gfit_chi2_m");
  if (lep_gfit_chi2_m_branch) lep_gfit_chi2_m_branch->SetAddress(&lep_gfit_chi2_m_);
  lep_gfit_validSTAHits_m_branch = tree->GetBranch("lep_gfit_validSTAHits_m");
  if (lep_gfit_validSTAHits_m_branch) lep_gfit_validSTAHits_m_branch->SetAddress(&lep_gfit_validSTAHits_m_);
  lep_numberOfMatchedStations_m_branch = tree->GetBranch("lep_numberOfMatchedStations_m");
  if (lep_numberOfMatchedStations_m_branch) lep_numberOfMatchedStations_m_branch->SetAddress(&lep_numberOfMatchedStations_m_);
  lep_pid_PFMuon_m_branch = tree->GetBranch("lep_pid_PFMuon_m");
  if (lep_pid_PFMuon_m_branch) lep_pid_PFMuon_m_branch->SetAddress(&lep_pid_PFMuon_m_);
  lep_segmCompatibility_m_branch = tree->GetBranch("lep_segmCompatibility_m");
  if (lep_segmCompatibility_m_branch) lep_segmCompatibility_m_branch->SetAddress(&lep_segmCompatibility_m_);
  lep_trkKink_m_branch = tree->GetBranch("lep_trkKink_m");
  if (lep_trkKink_m_branch) lep_trkKink_m_branch->SetAddress(&lep_trkKink_m_);
  lep_validPixelHits_m_branch = tree->GetBranch("lep_validPixelHits_m");
  if (lep_validPixelHits_m_branch) lep_validPixelHits_m_branch->SetAddress(&lep_validPixelHits_m_);
...
void CMS3::GetEntry(unsigned int idx) {
  ...
  lep_bdt1_isLoaded = false;
  lep_bdt2_isLoaded = false;
  lep_bdt3_isLoaded = false;
  ...
  lep_pass_POG_loose_noiso_isLoaded = false;
  lep_pass_POG_medium_noiso_isLoaded = false;
  lep_pass_POG_tight_noiso_isLoaded = false;
  ...
  lep_exp_innerlayers_isLoaded = false;
  lep_exp_outerlayers_isLoaded = false;
  lep_nlayers_isLoaded = false;
  lep_type_isLoaded = false;
  lep_validHits_isLoaded = false;
  lep_dEtaIn_e_isLoaded = false;
  lep_dEtaOut_e_isLoaded = false;
  lep_dPhiIn_e_isLoaded = false;
  lep_ecalEnergy_e_isLoaded = false;
  lep_ecalEnergyError_e_isLoaded = false;
  lep_ecalPFClusterIso_e_isLoaded = false;
  lep_eOverPIn_e_isLoaded = false;
  lep_hcalPFClusterIso_e_isLoaded = false;
  lep_hOverE_e_isLoaded = false;
  lep_scSeedEta_e_isLoaded = false;
  lep_sigmaIEtaIEta_full5x5_e_isLoaded = false;
  lep_tkIso_e_isLoaded = false;
  lep_goodGlb_m_isLoaded = false;
  lep_isGlobal_m_isLoaded = false;
  lep_isTracker_m_isLoaded = false;
  lep_gfit_ndof_m_isLoaded = false;
  lep_chi2LocalPosition_m_isLoaded = false;
  lep_gfit_chi2_m_isLoaded = false;
  lep_gfit_validSTAHits_m_isLoaded = false;
  lep_numberOfMatchedStations_m_isLoaded = false;
  lep_pid_PFMuon_m_isLoaded = false;
  lep_segmCompatibility_m_isLoaded = false;
  lep_trkKink_m_isLoaded = false;
  lep_validPixelHits_m_isLoaded = false;
...
void CMS3::LoadAllBranches() {
  ...
  if (lep_bdt1_branch != 0) lep_bdt1();
  if (lep_bdt2_branch != 0) lep_bdt2();
  if (lep_bdt3_branch != 0) lep_bdt3();
  ...
  if (lep_pass_POG_loose_noiso_branch != 0) lep_pass_POG_loose_noiso();
  if (lep_pass_POG_medium_noiso_branch != 0) lep_pass_POG_medium_noiso();
  if (lep_pass_POG_tight_noiso_branch != 0) lep_pass_POG_tight_noiso();
  ...
  if (lep_exp_innerlayers_branch != 0) lep_exp_innerlayers();
  if (lep_exp_outerlayers_branch != 0) lep_exp_outerlayers();
  if (lep_nlayers_branch != 0) lep_nlayers();
  if (lep_type_branch != 0) lep_type();
  if (lep_validHits_branch != 0) lep_validHits();
  if (lep_dEtaIn_e_branch != 0) lep_dEtaIn_e();
  if (lep_dEtaOut_e_branch != 0) lep_dEtaOut_e();
  if (lep_dPhiIn_e_branch != 0) lep_dPhiIn_e();
  if (lep_ecalEnergy_e_branch != 0) lep_ecalEnergy_e();
  if (lep_ecalEnergyError_e_branch != 0) lep_ecalEnergyError_e();
  if (lep_ecalPFClusterIso_e_branch != 0) lep_ecalPFClusterIso_e();
  if (lep_eOverPIn_e_branch != 0) lep_eOverPIn_e();
  if (lep_hcalPFClusterIso_e_branch != 0) lep_hcalPFClusterIso_e();
  if (lep_hOverE_e_branch != 0) lep_hOverE_e();
  if (lep_scSeedEta_e_branch != 0) lep_scSeedEta_e();
  if (lep_sigmaIEtaIEta_full5x5_e_branch != 0) lep_sigmaIEtaIEta_full5x5_e();
  if (lep_tkIso_e_branch != 0) lep_tkIso_e();
  if (lep_goodGlb_m_branch != 0) lep_goodGlb_m();
  if (lep_isGlobal_m_branch != 0) lep_isGlobal_m();
  if (lep_isTracker_m_branch != 0) lep_isTracker_m();
  if (lep_gfit_ndof_m_branch != 0) lep_gfit_ndof_m();
  if (lep_chi2LocalPosition_m_branch != 0) lep_chi2LocalPosition_m();
  if (lep_gfit_chi2_m_branch != 0) lep_gfit_chi2_m();
  if (lep_gfit_validSTAHits_m_branch != 0) lep_gfit_validSTAHits_m();
  if (lep_numberOfMatchedStations_m_branch != 0) lep_numberOfMatchedStations_m();
  if (lep_pid_PFMuon_m_branch != 0) lep_pid_PFMuon_m();
  if (lep_segmCompatibility_m_branch != 0) lep_segmCompatibility_m();
  if (lep_trkKink_m_branch != 0) lep_trkKink_m();
  if (lep_validPixelHits_m_branch != 0) lep_validPixelHits_m();
...
const int &CMS3::lumi() {
  if (not lumi_isLoaded) {
    ...
    lumi_isLoaded = true;
    if (doprintusage) cout << "lumi" << endl;
  }
  return lumi_;
}
...
const int &CMS3::isData() {
  if (not isData_isLoaded) {
    ...
    if (doprintusage) cout << "isData" << endl;
  }
  return isData_;
}

const bool &CMS3::evt_passgoodrunlist() {
  if (not evt_passgoodrunlist_isLoaded) {
    ...
    if (doprintusage) cout << "evt_passgoodrunlist" << endl;
  }
...
const float &CMS3::evt_scale1fb() {
  if (not evt_scale1fb_isLoaded) {
    ...
    if (doprintusage) cout << "evt_scale1fb" << endl;
  }
...
const float &CMS3::evt_fixgridfastjet_allcalo_rho() {
  if (not evt_fixgridfastjet_allcalo_rho_isLoaded) {
    ...
    if (doprintusage) cout << "evt_fixgridfastjet_allcalo_rho" << endl;
  }
...
const float &CMS3::evt_xsec() {
  if (not evt_xsec_isLoaded) {
    ...
    if (doprintusage) cout << "evt_xsec" << endl;
  }
  return evt_xsec_;
}
...
const float &CMS3::evt_kfactor() {
  if (not evt_kfactor_isLoaded) {
    ...
    if (doprintusage) cout << "evt_kfactor" << endl;
  }
  return evt_kfactor_;
}
...
const float &CMS3::evt_filter() {
  if (not evt_filter_isLoaded) {
    ...
    if (doprintusage) cout << "evt_filter" << endl;
  }
  return evt_filter_;
}

const int &CMS3::evt_nEvts() {
  if (not evt_nEvts_isLoaded) {
    ...
    if (doprintusage) cout << "evt_nEvts" << endl;
  }
  return evt_nEvts_;
}
...
const vector<TString> &CMS3::evt_dataset() {
  if (not evt_dataset_isLoaded) {
    ...
    if (doprintusage) cout << "evt_dataset" << endl;
  }
  return *evt_dataset_;
}
...
const float &CMS3::puWeight() {
  if (not puWeight_isLoaded) {
    ...
    if (doprintusage) cout << "puWeight" << endl;
  }
  return puWeight_;
}
...
const int &CMS3::nVert() {
  if (not nVert_isLoaded) {
    ...
    nVert_isLoaded = true;
    if (doprintusage) cout << "nVert" << endl;
  }
  return nVert_;
}
...
const int &CMS3::firstgoodvertex() {
  if (not firstgoodvertex_isLoaded) {
    ...
    if (doprintusage) cout << "firstgoodvertex" << endl;
  }
...
const int &CMS3::nTrueInt() {
  if (not nTrueInt_isLoaded) {
    ...
    if (doprintusage) cout << "nTrueInt" << endl;
  }
  return nTrueInt_;
}
...
const float &CMS3::rho() {
  if (not rho_isLoaded) {
    ...
    rho_isLoaded = true;
    if (doprintusage) cout << "rho" << endl;
  }
  return rho_;
}

const float &CMS3::rho25() {
  if (not rho25_isLoaded) {
    ...
    rho25_isLoaded = true;
    if (doprintusage) cout << "rho25" << endl;
  }
  return rho25_;
}
...
const float &CMS3::gen_ht() {
  if (not gen_ht_isLoaded) {
    ...
    if (doprintusage) cout << "gen_ht" << endl;
  }
  return gen_ht_;
}

const int &CMS3::nBJetTight() {
  if (not nBJetTight_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetTight" << endl;
  }
  return nBJetTight_;
}

const int &CMS3::nBJetMedium() {
  if (not nBJetMedium_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetMedium" << endl;
  }
  return nBJetMedium_;
}

const int &CMS3::nBJetLoose() {
  if (not nBJetLoose_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetLoose" << endl;
  }
  return nBJetLoose_;
}

const int &CMS3::nBJetTight_up() {
  if (not nBJetTight_up_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetTight_up" << endl;
  }
  return nBJetTight_up_;
}

const int &CMS3::nBJetMedium_up() {
  if (not nBJetMedium_up_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetMedium_up" << endl;
  }
  return nBJetMedium_up_;
}

const int &CMS3::nBJetLoose_up() {
  if (not nBJetLoose_up_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetLoose_up" << endl;
  }
  return nBJetLoose_up_;
}

const int &CMS3::nBJetTight_dn() {
  if (not nBJetTight_dn_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetTight_dn" << endl;
  }
  return nBJetTight_dn_;
}

const int &CMS3::nBJetMedium_dn() {
  if (not nBJetMedium_dn_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetMedium_dn" << endl;
  }
  return nBJetMedium_dn_;
}

const int &CMS3::nBJetLoose_dn() {
  if (not nBJetLoose_dn_isLoaded) {
    ...
    if (doprintusage) cout << "nBJetLoose_dn" << endl;
  }
...
const int &CMS3::nJet200MuFrac50DphiMet() {
  if (not nJet200MuFrac50DphiMet_isLoaded) {
    ...
    if (doprintusage) cout << "nJet200MuFrac50DphiMet" << endl;
  }
...
const int &CMS3::nMuons10() {
  if (not nMuons10_isLoaded) {
    ...
    if (doprintusage) cout << "nMuons10" << endl;
  }
  return nMuons10_;
}
...
const int &CMS3::nBadMuons20() {
  if (not nBadMuons20_isLoaded) {
    ...
    if (doprintusage) cout << "nBadMuons20" << endl;
  }
  return nBadMuons20_;
}
...
const int &CMS3::nElectrons10() {
  if (not nElectrons10_isLoaded) {
    ...
    if (doprintusage) cout << "nElectrons10" << endl;
  }
...
const int &CMS3::nGammas20() {
  if (not nGammas20_isLoaded) {
    ...
    if (doprintusage) cout << "nGammas20" << endl;
  }
  return nGammas20_;
}
...
const int &CMS3::nTaus20() {
  if (not nTaus20_isLoaded) {
    ...
    if (doprintusage) cout << "nTaus20" << endl;
  }
  return nTaus20_;
}
...
const float &CMS3::met_pt() {
  if (not met_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_pt" << endl;
  }
  return met_pt_;
}
...
const float &CMS3::met_phi() {
  if (not met_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_phi" << endl;
  }
  return met_phi_;
}

const float &CMS3::met_calo_pt() {
  if (not met_calo_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_calo_pt" << endl;
  }
  return met_calo_pt_;
}

const float &CMS3::met_calo_phi() {
  if (not met_calo_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_calo_phi" << endl;
  }
  return met_calo_phi_;
}

const float &CMS3::met_miniaod_pt() {
  if (not met_miniaod_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_miniaod_pt" << endl;
  }
  return met_miniaod_pt_;
}

const float &CMS3::met_miniaod_phi() {
  if (not met_miniaod_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_miniaod_phi" << endl;
  }
  return met_miniaod_phi_;
}

const float &CMS3::met_muegclean_pt() {
  if (not met_muegclean_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_muegclean_pt" << endl;
  }
  return met_muegclean_pt_;
}

const float &CMS3::met_muegclean_phi() {
  if (not met_muegclean_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_muegclean_phi" << endl;
  }
...
const float &CMS3::met_rawPt() {
  if (not met_rawPt_isLoaded) {
    ...
    if (doprintusage) cout << "met_rawPt" << endl;
  }
  return met_rawPt_;
}
...
const float &CMS3::met_rawPhi() {
  if (not met_rawPhi_isLoaded) {
    ...
    if (doprintusage) cout << "met_rawPhi" << endl;
  }
  return met_rawPhi_;
}
...
const float &CMS3::met_genPt() {
  if (not met_genPt_isLoaded) {
    ...
    if (doprintusage) cout << "met_genPt" << endl;
  }
  return met_genPt_;
}
...
const float &CMS3::met_genPhi() {
  if (not met_genPhi_isLoaded) {
    ...
    if (doprintusage) cout << "met_genPhi" << endl;
  }
  return met_genPhi_;
}

const float &CMS3::sumet_raw() {
  if (not sumet_raw_isLoaded) {
    ...
    if (doprintusage) cout << "sumet_raw" << endl;
  }
  return sumet_raw_;
}
...
const int &CMS3::Flag_ecalLaserCorrFilter() {
  if (not Flag_ecalLaserCorrFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_ecalLaserCorrFilter" << endl;
  }
...
const int &CMS3::Flag_hcalLaserEventFilter() {
  if (not Flag_hcalLaserEventFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_hcalLaserEventFilter" << endl;
  }
...
const int &CMS3::Flag_trackingFailureFilter() {
  if (not Flag_trackingFailureFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_trackingFailureFilter" << endl;
  }
...
const int &CMS3::Flag_CSCTightHaloFilter() {
  if (not Flag_CSCTightHaloFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_CSCTightHaloFilter" << endl;
  }
...
const int &CMS3::Flag_HBHENoiseFilter() {
  if (not Flag_HBHENoiseFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_HBHENoiseFilter" << endl;
  }
...
const int &CMS3::Flag_HBHEIsoNoiseFilter() {
  if (not Flag_HBHEIsoNoiseFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_HBHEIsoNoiseFilter" << endl;
  }
...
const int &CMS3::Flag_CSCTightHalo2015Filter() {
  if (not Flag_CSCTightHalo2015Filter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_CSCTightHalo2015Filter" << endl;
  }
...
const int &CMS3::Flag_EcalDeadCellTriggerPrimitiveFilter() {
  if (not Flag_EcalDeadCellTriggerPrimitiveFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_EcalDeadCellTriggerPrimitiveFilter" << endl;
  }
...
const int &CMS3::Flag_goodVertices() {
  if (not Flag_goodVertices_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_goodVertices" << endl;
  }
...
const int &CMS3::Flag_eeBadScFilter() {
  if (not Flag_eeBadScFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_eeBadScFilter" << endl;
  }
...
const int &CMS3::Flag_globalTightHalo2016() {
  if (not Flag_globalTightHalo2016_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_globalTightHalo2016" << endl;
  }
...
const int &CMS3::Flag_badMuonFilter() {
  if (not Flag_badMuonFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_badMuonFilter" << endl;
  }
...
const int &CMS3::Flag_badChargedCandidateFilter() {
  if (not Flag_badChargedCandidateFilter_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_badChargedCandidateFilter" << endl;
  }
...
const int &CMS3::Flag_badMuonFilterv2() {
  if (not Flag_badMuonFilterv2_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_badMuonFilterv2" << endl;
  }
  return Flag_badMuonFilterv2_;
}

const int &CMS3::Flag_badChargedCandidateFilterv2() {
  if (not Flag_badChargedCandidateFilterv2_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_badChargedCandidateFilterv2" << endl;
  }
...
const int &CMS3::Flag_badMuons() {
  if (not Flag_badMuons_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_badMuons" << endl;
  }
...
const int &CMS3::Flag_duplicateMuons() {
  if (not Flag_duplicateMuons_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_duplicateMuons" << endl;
  }
...
const int &CMS3::Flag_noBadMuons() {
  if (not Flag_noBadMuons_isLoaded) {
    ...
    if (doprintusage) cout << "Flag_noBadMuons" << endl;
  }
...
const int &CMS3::HLT_singleEl() {
  if (not HLT_singleEl_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_singleEl" << endl;
  }
...
const int &CMS3::HLT_singleMu() {
  if (not HLT_singleMu_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_singleMu" << endl;
  }
  return HLT_singleMu_;
}

const int &CMS3::HLT_singleMu_noiso() {
  if (not HLT_singleMu_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_singleMu_noiso" << endl;
  }
  return HLT_singleMu_noiso_;
}

const int &CMS3::HLT_DoubleEl_noiso() {
  if (not HLT_DoubleEl_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleEl_noiso" << endl;
  }
...
const int &CMS3::HLT_DoubleEl() {
  if (not HLT_DoubleEl_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleEl" << endl;
  }
...
const int &CMS3::HLT_DoubleEl_DZ() {
  if (not HLT_DoubleEl_DZ_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleEl_DZ" << endl;
  }
...
const int &CMS3::HLT_DoubleEl_DZ_2() {
  if (not HLT_DoubleEl_DZ_2_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleEl_DZ_2" << endl;
  }
...
const int &CMS3::HLT_MuEG() {
  if (not HLT_MuEG_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_MuEG" << endl;
  }
  return HLT_MuEG_;
}

const int &CMS3::HLT_MuEG_2() {
  if (not HLT_MuEG_2_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_MuEG_2" << endl;
  }
  return HLT_MuEG_2_;
}

const int &CMS3::HLT_MuEG_noiso() {
  if (not HLT_MuEG_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_MuEG_noiso" << endl;
  }
  return HLT_MuEG_noiso_;
}

const int &CMS3::HLT_MuEG_noiso_2() {
  if (not HLT_MuEG_noiso_2_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_MuEG_noiso_2" << endl;
  }
  return HLT_MuEG_noiso_2_;
}

const int &CMS3::HLT_Mu8_EG17() {
  if (not HLT_Mu8_EG17_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu8_EG17" << endl;
  }
  return HLT_Mu8_EG17_;
}

const int &CMS3::HLT_Mu8_EG23() {
  if (not HLT_Mu8_EG23_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu8_EG23" << endl;
  }
  return HLT_Mu8_EG23_;
}

const int &CMS3::HLT_Mu8_EG23_DZ() {
  if (not HLT_Mu8_EG23_DZ_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu8_EG23_DZ" << endl;
  }
  return HLT_Mu8_EG23_DZ_;
}

const int &CMS3::HLT_Mu12_EG23_DZ() {
  if (not HLT_Mu12_EG23_DZ_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu12_EG23_DZ" << endl;
  }
  return HLT_Mu12_EG23_DZ_;
}

const int &CMS3::HLT_Mu17_EG12() {
  if (not HLT_Mu17_EG12_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu17_EG12" << endl;
  }
  return HLT_Mu17_EG12_;
}

const int &CMS3::HLT_Mu23_EG8() {
  if (not HLT_Mu23_EG8_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu23_EG8" << endl;
  }
  return HLT_Mu23_EG8_;
}

const int &CMS3::HLT_Mu23_EG8_DZ() {
  if (not HLT_Mu23_EG8_DZ_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu23_EG8_DZ" << endl;
  }
  return HLT_Mu23_EG8_DZ_;
}

const int &CMS3::HLT_Mu23_EG12() {
  if (not HLT_Mu23_EG12_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu23_EG12" << endl;
  }
  return HLT_Mu23_EG12_;
}

const int &CMS3::HLT_Mu23_EG12_DZ() {
  if (not HLT_Mu23_EG12_DZ_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Mu23_EG12_DZ" << endl;
  }
  return HLT_Mu23_EG12_DZ_;
}

const int &CMS3::HLT_DoubleMu_noiso() {
  if (not HLT_DoubleMu_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu_noiso" << endl;
  }
  return HLT_DoubleMu_noiso_;
}

const int &CMS3::HLT_DoubleMu_noiso_27_8() {
  if (not HLT_DoubleMu_noiso_27_8_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu_noiso_27_8" << endl;
  }
  return HLT_DoubleMu_noiso_27_8_;
}

const int &CMS3::HLT_DoubleMu_noiso_30_11() {
  if (not HLT_DoubleMu_noiso_30_11_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu_noiso_30_11" << endl;
  }
  return HLT_DoubleMu_noiso_30_11_;
}

const int &CMS3::HLT_DoubleMu_noiso_40_11() {
  if (not HLT_DoubleMu_noiso_40_11_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu_noiso_40_11" << endl;
  }
...
const int &CMS3::HLT_DoubleMu() {
  if (not HLT_DoubleMu_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu" << endl;
  }
  return HLT_DoubleMu_;
}

const int &CMS3::HLT_DoubleMu_tk() {
  if (not HLT_DoubleMu_tk_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu_tk" << endl;
  }
  return HLT_DoubleMu_tk_;
}

const int &CMS3::HLT_DoubleMu_dbltk() {
  if (not HLT_DoubleMu_dbltk_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu_dbltk" << endl;
  }
  return HLT_DoubleMu_dbltk_;
}

const int &CMS3::HLT_DoubleMu_nonDZ() {
  if (not HLT_DoubleMu_nonDZ_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu_nonDZ" << endl;
  }
  return HLT_DoubleMu_nonDZ_;
}

const int &CMS3::HLT_DoubleMu_tk_nonDZ() {
  if (not HLT_DoubleMu_tk_nonDZ_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_DoubleMu_tk_nonDZ" << endl;
  }
...
const int &CMS3::HLT_Photon22_R9Id90_HE10_IsoM() {
  if (not HLT_Photon22_R9Id90_HE10_IsoM_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon22_R9Id90_HE10_IsoM" << endl;
  }
...
const int &CMS3::HLT_Photon30_R9Id90_HE10_IsoM() {
  if (not HLT_Photon30_R9Id90_HE10_IsoM_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon30_R9Id90_HE10_IsoM" << endl;
  }
...
const int &CMS3::HLT_Photon36_R9Id90_HE10_IsoM() {
  if (not HLT_Photon36_R9Id90_HE10_IsoM_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon36_R9Id90_HE10_IsoM" << endl;
  }
...
const int &CMS3::HLT_Photon50_R9Id90_HE10_IsoM() {
  if (not HLT_Photon50_R9Id90_HE10_IsoM_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon50_R9Id90_HE10_IsoM" << endl;
  }
...
const int &CMS3::HLT_Photon75_R9Id90_HE10_IsoM() {
  if (not HLT_Photon75_R9Id90_HE10_IsoM_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon75_R9Id90_HE10_IsoM" << endl;
  }
...
const int &CMS3::HLT_Photon90_R9Id90_HE10_IsoM() {
  if (not HLT_Photon90_R9Id90_HE10_IsoM_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon90_R9Id90_HE10_IsoM" << endl;
  }
...
const int &CMS3::HLT_Photon120_R9Id90_HE10_IsoM() {
  if (not HLT_Photon120_R9Id90_HE10_IsoM_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon120_R9Id90_HE10_IsoM" << endl;
  }
...
const int &CMS3::HLT_Photon165_R9Id90_HE10_IsoM() {
  if (not HLT_Photon165_R9Id90_HE10_IsoM_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon165_R9Id90_HE10_IsoM" << endl;
  }
...
const int &CMS3::HLT_Photon165_HE10() {
  if (not HLT_Photon165_HE10_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon165_HE10" << endl;
  }
  return HLT_Photon165_HE10_;
}

const int &CMS3::HLT_CaloJet500_NoJetID() {
  if (not HLT_CaloJet500_NoJetID_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_CaloJet500_NoJetID" << endl;
  }
  return HLT_CaloJet500_NoJetID_;
}

const int &CMS3::HLT_ECALHT800_NoJetID() {
  if (not HLT_ECALHT800_NoJetID_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_ECALHT800_NoJetID" << endl;
  }
  return HLT_ECALHT800_NoJetID_;
}

const bool &CMS3::HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton() {
  if (not HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton" << endl;
  }
  return HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton_;
}

const bool &CMS3::HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton() {
  if (not HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton" << endl;
  }
  return HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton_;
}

const bool &CMS3::HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton() {
  if (not HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton" << endl;
  }
  return HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton_;
}

const bool &CMS3::HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton() {
  if (not HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton" << endl;
  }
  return HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton_;
}

const bool &CMS3::HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton() {
  if (not HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton" << endl;
  }
  return HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton_;
}

const bool &CMS3::HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton() {
  if (not HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton" << endl;
  }
  return HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton_;
}

const bool &CMS3::HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton() {
  if (not HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton" << endl;
  }
  return HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton_;
}

const bool &CMS3::HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton() {
  if (not HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton" << endl;
  }
  return HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton_;
}

const bool &CMS3::HLT_Photon165_HE10_matchedtophoton() {
  if (not HLT_Photon165_HE10_matchedtophoton_isLoaded) {
    ...
    if (doprintusage) cout << "HLT_Photon165_HE10_matchedtophoton" << endl;
  }
  return HLT_Photon165_HE10_matchedtophoton_;
}

const float &CMS3::dilmass() {
  if (not dilmass_isLoaded) {
    ...
    if (doprintusage) cout << "dilmass" << endl;
  }
  return dilmass_;
}

const float &CMS3::dilpt() {
  if (not dilpt_isLoaded) {
    ...
    dilpt_isLoaded = true;
    if (doprintusage) cout << "dilpt" << endl;
  }
  return dilpt_;
}

const float &CMS3::dRll() {
  if (not dRll_isLoaded) {
    ...
    dRll_isLoaded = true;
    if (doprintusage) cout << "dRll" << endl;
  }
  return dRll_;
}

const float &CMS3::matched_neutralemf() {
  if (not matched_neutralemf_isLoaded) {
    ...
    if (doprintusage) cout << "matched_neutralemf" << endl;
  }
  return matched_neutralemf_;
}

const float &CMS3::matched_emf() {
  if (not matched_emf_isLoaded) {
    ...
    if (doprintusage) cout << "matched_emf" << endl;
  }
  return matched_emf_;
}

const bool &CMS3::elveto() {
  if (not elveto_isLoaded) {
    ...
    if (doprintusage) cout << "elveto" << endl;
  }
  return elveto_;
}
...
const int &CMS3::nlep() {
  if (not nlep_isLoaded) {
    ...
    nlep_isLoaded = true;
    if (doprintusage) cout << "nlep" << endl;
  }
  return nlep_;
}

const int &CMS3::nveto_leptons() {
  if (not nveto_leptons_isLoaded) {
    ...
    if (doprintusage) cout << "nveto_leptons" << endl;
  }
  return nveto_leptons_;
}

const int &CMS3::nVetoEl_relIso03EAless01() {
  if (not nVetoEl_relIso03EAless01_isLoaded) {
    ...
    if (doprintusage) cout << "nVetoEl_relIso03EAless01" << endl;
  }
  return nVetoEl_relIso03EAless01_;
}

const int &CMS3::nVetoEl_relIso03EAless02() {
  if (not nVetoEl_relIso03EAless02_isLoaded) {
    ...
    if (doprintusage) cout << "nVetoEl_relIso03EAless02" << endl;
  }
  return nVetoEl_relIso03EAless02_;
}

const int &CMS3::nVetoEl_relIso03EAless03() {
  if (not nVetoEl_relIso03EAless03_isLoaded) {
    ...
    if (doprintusage) cout << "nVetoEl_relIso03EAless03" << endl;
  }
  return nVetoEl_relIso03EAless03_;
}

const int &CMS3::nVetoEl_relIso03EAless04() {
  if (not nVetoEl_relIso03EAless04_isLoaded) {
    ...
    if (doprintusage) cout << "nVetoEl_relIso03EAless04" << endl;
  }
  return nVetoEl_relIso03EAless04_;
}

const int &CMS3::nVetoMu_relIso03EAless01() {
  if (not nVetoMu_relIso03EAless01_isLoaded) {
    ...
    if (doprintusage) cout << "nVetoMu_relIso03EAless01" << endl;
  }
  return nVetoMu_relIso03EAless01_;
}

const int &CMS3::nVetoMu_relIso03EAless02() {
  if (not nVetoMu_relIso03EAless02_isLoaded) {
    ...
    if (doprintusage) cout << "nVetoMu_relIso03EAless02" << endl;
  }
  return nVetoMu_relIso03EAless02_;
}

const int &CMS3::nVetoMu_relIso03EAless03() {
  if (not nVetoMu_relIso03EAless03_isLoaded) {
    ...
    if (doprintusage) cout << "nVetoMu_relIso03EAless03" << endl;
  }
  return nVetoMu_relIso03EAless03_;
}

const int &CMS3::nVetoMu_relIso03EAless04() {
  if (not nVetoMu_relIso03EAless04_isLoaded) {
    ...
    if (doprintusage) cout << "nVetoMu_relIso03EAless04" << endl;
  }
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::lep_p4() {
  if (not lep_p4_isLoaded) {
    ...
    if (doprintusage) cout << "lep_p4" << endl;
  }
  return *lep_p4_;
}
...
const vector<float> &CMS3::lep_pt() {
  if (not lep_pt_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pt" << endl;
  }
  return *lep_pt_;
}
...
const vector<float> &CMS3::lep_eta() {
  if (not lep_eta_isLoaded) {
    ...
    if (doprintusage) cout << "lep_eta" << endl;
  }
  return *lep_eta_;
}
...
const vector<float> &CMS3::lep_phi() {
  if (not lep_phi_isLoaded) {
    ...
    if (doprintusage) cout << "lep_phi" << endl;
  }
  return *lep_phi_;
}

const vector<float> &CMS3::lep_mass() {
  if (not lep_mass_isLoaded) {
    ...
    if (doprintusage) cout << "lep_mass" << endl;
  }
  return *lep_mass_;
}
...
const vector<int> &CMS3::lep_charge() {
  if (not lep_charge_isLoaded) {
    ...
    if (doprintusage) cout << "lep_charge" << endl;
  }
  return *lep_charge_;
}

const vector<float> &CMS3::lep_bdt1() {
  if (not lep_bdt1_isLoaded) {
    if (lep_bdt1_branch != 0) {
      lep_bdt1_branch->GetEntry(index);
    } else {
      printf("branch lep_bdt1_branch does not exist!\n");
      exit(1);
    }
    lep_bdt1_isLoaded = true;
    if (doprintusage) cout << "lep_bdt1" << endl;
  }
  return *lep_bdt1_;
}

const vector<float> &CMS3::lep_bdt2() {
  if (not lep_bdt2_isLoaded) {
    if (lep_bdt2_branch != 0) {
      lep_bdt2_branch->GetEntry(index);
    } else {
      printf("branch lep_bdt2_branch does not exist!\n");
      exit(1);
    }
    lep_bdt2_isLoaded = true;
    if (doprintusage) cout << "lep_bdt2" << endl;
  }
  return *lep_bdt2_;
}

const vector<float> &CMS3::lep_bdt3() {
  if (not lep_bdt3_isLoaded) {
    if (lep_bdt3_branch != 0) {
      lep_bdt3_branch->GetEntry(index);
    } else {
      printf("branch lep_bdt3_branch does not exist!\n");
      exit(1);
    }
    lep_bdt3_isLoaded = true;
    if (doprintusage) cout << "lep_bdt3" << endl;
  }
  return *lep_bdt3_;
}

const vector<int> &CMS3::lep_3ch_agree() {
  if (not lep_3ch_agree_isLoaded) {
    ...
    if (doprintusage) cout << "lep_3ch_agree" << endl;
  }
...
const vector<int> &CMS3::lep_isFromW() {
  if (not lep_isFromW_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isFromW" << endl;
  }
  return *lep_isFromW_;
}
...
const vector<int> &CMS3::lep_isFromZ() {
  if (not lep_isFromZ_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isFromZ" << endl;
  }
  return *lep_isFromZ_;
}
...
const vector<int> &CMS3::lep_isFromB() {
  if (not lep_isFromB_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isFromB" << endl;
  }
  return *lep_isFromB_;
}
...
const vector<int> &CMS3::lep_isFromC() {
  if (not lep_isFromC_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isFromC" << endl;
  }
  return *lep_isFromC_;
}
...
const vector<int> &CMS3::lep_isFromL() {
  if (not lep_isFromL_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isFromL" << endl;
  }
  return *lep_isFromL_;
}
...
const vector<int> &CMS3::lep_isFromLF() {
  if (not lep_isFromLF_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isFromLF" << endl;
  }
  return *lep_isFromLF_;
}

const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::lep_closest_jet_p4() {
  if (not lep_closest_jet_p4_isLoaded) {
    ...
    if (doprintusage) cout << "lep_closest_jet_p4" << endl;
  }
...
const vector<float> &CMS3::lep_ptRatio() {
  if (not lep_ptRatio_isLoaded) {
    ...
    if (doprintusage) cout << "lep_ptRatio" << endl;
  }
  return *lep_ptRatio_;
}
...
const vector<int> &CMS3::lep_motherIdSS() {
  if (not lep_motherIdSS_isLoaded) {
    ...
    if (doprintusage) cout << "lep_motherIdSS" << endl;
  }
...
const vector<int> &CMS3::lep_genPart_index() {
  if (not lep_genPart_index_isLoaded) {
    ...
    if (doprintusage) cout << "lep_genPart_index" << endl;
  }
...
const vector<float> &CMS3::lep_coneCorrPt() {
  if (not lep_coneCorrPt_isLoaded) {
    ...
    if (doprintusage) cout << "lep_coneCorrPt" << endl;
  }
...
const vector<float> &CMS3::lep_ptRel() {
  if (not lep_ptRel_isLoaded) {
    ...
    if (doprintusage) cout << "lep_ptRel" << endl;
  }
  return *lep_ptRel_;
}

const vector<float> &CMS3::lep_relIso03() {
  if (not lep_relIso03_isLoaded) {
    ...
    if (doprintusage) cout << "lep_relIso03" << endl;
  }
  return *lep_relIso03_;
}

const vector<float> &CMS3::lep_relIso03DB() {
  if (not lep_relIso03DB_isLoaded) {
    ...
    if (doprintusage) cout << "lep_relIso03DB" << endl;
  }
  return *lep_relIso03DB_;
}

const vector<float> &CMS3::lep_relIso03EA() {
  if (not lep_relIso03EA_isLoaded) {
    ...
    if (doprintusage) cout << "lep_relIso03EA" << endl;
  }
...
const vector<float> &CMS3::lep_relIso03EAv2() {
  if (not lep_relIso03EAv2_isLoaded) {
    ...
    if (doprintusage) cout << "lep_relIso03EAv2" << endl;
  }
  return *lep_relIso03EAv2_;
}

const vector<float> &CMS3::lep_relIso04DB() {
  if (not lep_relIso04DB_isLoaded) {
    ...
    if (doprintusage) cout << "lep_relIso04DB" << endl;
  }
  return *lep_relIso04DB_;
}

const vector<float> &CMS3::lep_relIso04EA() {
  if (not lep_relIso04EA_isLoaded) {
    ...
    if (doprintusage) cout << "lep_relIso04EA" << endl;
  }
...
const vector<float> &CMS3::lep_relIso04EAv2() {
  if (not lep_relIso04EAv2_isLoaded) {
    ...
    if (doprintusage) cout << "lep_relIso04EAv2" << endl;
  }
  return *lep_relIso04EAv2_;
}

const vector<float> &CMS3::lep_miniRelIsoCMS3_EA() {
  if (not lep_miniRelIsoCMS3_EA_isLoaded) {
    ...
    if (doprintusage) cout << "lep_miniRelIsoCMS3_EA" << endl;
  }
  return *lep_miniRelIsoCMS3_EA_;
}

const vector<float> &CMS3::lep_miniRelIsoCMS3_EAv2() {
  if (not lep_miniRelIsoCMS3_EAv2_isLoaded) {
    ...
    if (doprintusage) cout << "lep_miniRelIsoCMS3_EAv2" << endl;
  }
  return *lep_miniRelIsoCMS3_EAv2_;
}

const vector<float> &CMS3::lep_miniRelIsoCMS3_DB() {
  if (not lep_miniRelIsoCMS3_DB_isLoaded) {
    ...
    if (doprintusage) cout << "lep_miniRelIsoCMS3_DB" << endl;
  }
  return *lep_miniRelIsoCMS3_DB_;
}

const vector<int> &CMS3::lep_isTriggerSafenoIso_v1() {
  if (not lep_isTriggerSafenoIso_v1_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isTriggerSafenoIso_v1" << endl;
  }
  return *lep_isTriggerSafenoIso_v1_;
}

const vector<int> &CMS3::lep_isTriggerSafenoIso_v2() {
  if (not lep_isTriggerSafenoIso_v2_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isTriggerSafenoIso_v2" << endl;
  }
...
const vector<int> &CMS3::lep_isTriggerSafe_v1() {
  if (not lep_isTriggerSafe_v1_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isTriggerSafe_v1" << endl;
  }
  return *lep_isTriggerSafe_v1_;
}

const vector<int> &CMS3::lep_isTriggerSafe_v2() {
  if (not lep_isTriggerSafe_v2_isLoaded) {
    ...
    if (doprintusage) cout << "lep_isTriggerSafe_v2" << endl;
  }
  return *lep_isTriggerSafe_v2_;
}

const vector<int> &CMS3::lep_pass_POG_loose_noiso() {
  if (not lep_pass_POG_loose_noiso_isLoaded) {
    if (lep_pass_POG_loose_noiso_branch != 0) {
      lep_pass_POG_loose_noiso_branch->GetEntry(index);
    } else {
      printf("branch lep_pass_POG_loose_noiso_branch does not exist!\n");
      exit(1);
    }
    lep_pass_POG_loose_noiso_isLoaded = true;
    if (doprintusage) cout << "lep_pass_POG_loose_noiso" << endl;
  }
  return *lep_pass_POG_loose_noiso_;
}

const vector<int> &CMS3::lep_pass_POG_medium_noiso() {
  if (not lep_pass_POG_medium_noiso_isLoaded) {
    if (lep_pass_POG_medium_noiso_branch != 0) {
      lep_pass_POG_medium_noiso_branch->GetEntry(index);
    } else {
      printf("branch lep_pass_POG_medium_noiso_branch does not exist!\n");
      exit(1);
    }
    lep_pass_POG_medium_noiso_isLoaded = true;
    if (doprintusage) cout << "lep_pass_POG_medium_noiso" << endl;
  }
  return *lep_pass_POG_medium_noiso_;
}

const vector<int> &CMS3::lep_pass_POG_tight_noiso() {
  if (not lep_pass_POG_tight_noiso_isLoaded) {
    if (lep_pass_POG_tight_noiso_branch != 0) {
      lep_pass_POG_tight_noiso_branch->GetEntry(index);
    } else {
      printf("branch lep_pass_POG_tight_noiso_branch does not exist!\n");
      exit(1);
    }
    lep_pass_POG_tight_noiso_isLoaded = true;
    if (doprintusage) cout << "lep_pass_POG_tight_noiso" << endl;
  }
  return *lep_pass_POG_tight_noiso_;
}
...
const vector<int> &CMS3::lep_pass_VVV_cutbased_veto() {
  if (not lep_pass_VVV_cutbased_veto_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_veto" << endl;
  }
...
const vector<int> &CMS3::lep_pass_VVV_cutbased_veto_noiso() {
  if (not lep_pass_VVV_cutbased_veto_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_veto_noiso" << endl;
  }
  return *lep_pass_VVV_cutbased_veto_noiso_;
}

const vector<int> &CMS3::lep_pass_VVV_cutbased_veto_noiso_noip() {
  if (not lep_pass_VVV_cutbased_veto_noiso_noip_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_veto_noiso_noip" << endl;
  }
  return *lep_pass_VVV_cutbased_veto_noiso_noip_;
}

const vector<int> &CMS3::lep_pass_VVV_cutbased_veto_bak1() {
  if (not lep_pass_VVV_cutbased_veto_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_veto_bak1" << endl;
  }
  return *lep_pass_VVV_cutbased_veto_bak1_;
}

const vector<int> &CMS3::lep_pass_VVV_cutbased_veto_noiso_bak1() {
  if (not lep_pass_VVV_cutbased_veto_noiso_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_veto_noiso_bak1" << endl;
  }
  return *lep_pass_VVV_cutbased_veto_noiso_bak1_;
}

const vector<int> &CMS3::lep_pass_VVV_cutbased_veto_noiso_noip_bak1() {
  if (not lep_pass_VVV_cutbased_veto_noiso_noip_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_veto_noiso_noip_bak1" << endl;
  }
...
const vector<int> &CMS3::lep_pass_VVV_cutbased_fo() {
  if (not lep_pass_VVV_cutbased_fo_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_fo" << endl;
  }
...
const vector<int> &CMS3::lep_pass_VVV_cutbased_fo_noiso() {
  if (not lep_pass_VVV_cutbased_fo_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_fo_noiso" << endl;
  }
...
const vector<int> &CMS3::lep_pass_VVV_cutbased_tight_noiso() {
  if (not lep_pass_VVV_cutbased_tight_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_tight_noiso" << endl;
  }
...
const vector<int> &CMS3::lep_pass_VVV_cutbased_tight() {
  if (not lep_pass_VVV_cutbased_tight_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_cutbased_tight" << endl;
  }
  return *lep_pass_VVV_cutbased_tight_;
}

const vector<int> &CMS3::lep_pass_VVV_MVAbased_tight_noiso() {
  if (not lep_pass_VVV_MVAbased_tight_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_MVAbased_tight_noiso" << endl;
  }
  return *lep_pass_VVV_MVAbased_tight_noiso_;
}

const vector<int> &CMS3::lep_pass_VVV_MVAbased_tight() {
  if (not lep_pass_VVV_MVAbased_tight_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_MVAbased_tight" << endl;
  }
  return *lep_pass_VVV_MVAbased_tight_;
}

const vector<int> &CMS3::lep_pass_VVV_baseline() {
  if (not lep_pass_VVV_baseline_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pass_VVV_baseline" << endl;
  }
  return *lep_pass_VVV_baseline_;
}

const int &CMS3::nlep_VVV_cutbased_veto() {
  if (not nlep_VVV_cutbased_veto_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_veto" << endl;
  }
  return nlep_VVV_cutbased_veto_;
}

const int &CMS3::nlep_VVV_cutbased_veto_noiso() {
  if (not nlep_VVV_cutbased_veto_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_veto_noiso" << endl;
  }
  return nlep_VVV_cutbased_veto_noiso_;
}

const int &CMS3::nlep_VVV_cutbased_veto_noiso_noip() {
  if (not nlep_VVV_cutbased_veto_noiso_noip_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_veto_noiso_noip" << endl;
  }
  return nlep_VVV_cutbased_veto_noiso_noip_;
}

const int &CMS3::nlep_VVV_cutbased_veto_bak1() {
  if (not nlep_VVV_cutbased_veto_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_veto_bak1" << endl;
  }
  return nlep_VVV_cutbased_veto_bak1_;
}

const int &CMS3::nlep_VVV_cutbased_veto_noiso_bak1() {
  if (not nlep_VVV_cutbased_veto_noiso_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_veto_noiso_bak1" << endl;
  }
  return nlep_VVV_cutbased_veto_noiso_bak1_;
}

const int &CMS3::nlep_VVV_cutbased_veto_noiso_noip_bak1() {
  if (not nlep_VVV_cutbased_veto_noiso_noip_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_veto_noiso_noip_bak1" << endl;
  }
  return nlep_VVV_cutbased_veto_noiso_noip_bak1_;
}

const int &CMS3::nlep_VVV_cutbased_fo() {
  if (not nlep_VVV_cutbased_fo_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_fo" << endl;
  }
  return nlep_VVV_cutbased_fo_;
}

const int &CMS3::nlep_VVV_cutbased_fo_noiso() {
  if (not nlep_VVV_cutbased_fo_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_fo_noiso" << endl;
  }
  return nlep_VVV_cutbased_fo_noiso_;
}

const int &CMS3::nlep_VVV_cutbased_tight_noiso() {
  if (not nlep_VVV_cutbased_tight_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_tight_noiso" << endl;
  }
  return nlep_VVV_cutbased_tight_noiso_;
}

const int &CMS3::nlep_VVV_cutbased_tight() {
  if (not nlep_VVV_cutbased_tight_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_cutbased_tight" << endl;
  }
  return nlep_VVV_cutbased_tight_;
}

const int &CMS3::nlep_VVV_MVAbased_tight_noiso() {
  if (not nlep_VVV_MVAbased_tight_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_MVAbased_tight_noiso" << endl;
  }
  return nlep_VVV_MVAbased_tight_noiso_;
}

const int &CMS3::nlep_VVV_MVAbased_tight() {
  if (not nlep_VVV_MVAbased_tight_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_MVAbased_tight" << endl;
  }
  return nlep_VVV_MVAbased_tight_;
}

const int &CMS3::nlep_VVV_baseline() {
  if (not nlep_VVV_baseline_isLoaded) {
    ...
    if (doprintusage) cout << "nlep_VVV_baseline" << endl;
  }
...
const vector<int> &CMS3::lep_pdgId() {
  if (not lep_pdgId_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pdgId" << endl;
  }
  return *lep_pdgId_;
}

const vector<int> &CMS3::lep_mc_Id() {
  if (not lep_mc_Id_isLoaded) {
    ...
    if (doprintusage) cout << "lep_mc_Id" << endl;
  }
  return *lep_mc_Id_;
}
...
const vector<float> &CMS3::lep_dxy() {
  if (not lep_dxy_isLoaded) {
    ...
    if (doprintusage) cout << "lep_dxy" << endl;
  }
  return *lep_dxy_;
}
...
const vector<float> &CMS3::lep_ip3d() {
  if (not lep_ip3d_isLoaded) {
    ...
    if (doprintusage) cout << "lep_ip3d" << endl;
  }
  return *lep_ip3d_;
}
...
const vector<float> &CMS3::lep_ip3derr() {
  if (not lep_ip3derr_isLoaded) {
    ...
    if (doprintusage) cout << "lep_ip3derr" << endl;
  }
  return *lep_ip3derr_;
}
...
const vector<float> &CMS3::lep_etaSC() {
  if (not lep_etaSC_isLoaded) {
    ...
    if (doprintusage) cout << "lep_etaSC" << endl;
  }
  return *lep_etaSC_;
}

const vector<float> &CMS3::lep_r9() {
  if (not lep_r9_isLoaded) {
    ...
    if (doprintusage) cout << "lep_r9" << endl;
  }
  return *lep_r9_;
}
...
const vector<float> &CMS3::lep_dz() {
  if (not lep_dz_isLoaded) {
    ...
    if (doprintusage) cout << "lep_dz" << endl;
  }
  return *lep_dz_;
}

const vector<int> &CMS3::lep_tightId() {
  if (not lep_tightId_isLoaded) {
    ...
    if (doprintusage) cout << "lep_tightId" << endl;
  }
  return *lep_tightId_;
}

const vector<int> &CMS3::lep_mcMatchId() {
  if (not lep_mcMatchId_isLoaded) {
    ...
    if (doprintusage) cout << "lep_mcMatchId" << endl;
  }
...
const vector<int> &CMS3::lep_lostHits() {
  if (not lep_lostHits_isLoaded) {
    ...
    if (doprintusage) cout << "lep_lostHits" << endl;
  }
...
const vector<int> &CMS3::lep_convVeto() {
  if (not lep_convVeto_isLoaded) {
    ...
    if (doprintusage) cout << "lep_convVeto" << endl;
  }
...
const vector<int> &CMS3::lep_tightCharge() {
  if (not lep_tightCharge_isLoaded) {
    ...
    if (doprintusage) cout << "lep_tightCharge" << endl;
  }
...
const vector<float> &CMS3::lep_MVA() {
  if (not lep_MVA_isLoaded) {
    ...
    if (doprintusage) cout << "lep_MVA" << endl;
  }
  return *lep_MVA_;
}

const vector<float> &CMS3::lep_validfraction() {
  if (not lep_validfraction_isLoaded) {
    ...
    if (doprintusage) cout << "lep_validfraction" << endl;
  }
...
const vector<float> &CMS3::lep_pterr() {
  if (not lep_pterr_isLoaded) {
    ...
    if (doprintusage) cout << "lep_pterr" << endl;
  }
  return *lep_pterr_;
}
...
const vector<float> &CMS3::lep_trk_pt() {
  if (not lep_trk_pt_isLoaded) {
    ...
    if (doprintusage) cout << "lep_trk_pt" << endl;
  }
  return *lep_trk_pt_;
}

const vector<float> &CMS3::lep_sta_pterrOpt() {
  if (not lep_sta_pterrOpt_isLoaded) {
    ...
    if (doprintusage) cout << "lep_sta_pterrOpt" << endl;
  }
  return *lep_sta_pterrOpt_;
}

const vector<float> &CMS3::lep_glb_pterrOpt() {
  if (not lep_glb_pterrOpt_isLoaded) {
    ...
    if (doprintusage) cout << "lep_glb_pterrOpt" << endl;
  }
  return *lep_glb_pterrOpt_;
}

const vector<float> &CMS3::lep_x2ondof() {
  if (not lep_x2ondof_isLoaded) {
    ...
    if (doprintusage) cout << "lep_x2ondof" << endl;
  }
  return *lep_x2ondof_;
}

const vector<float> &CMS3::lep_sta_x2ondof() {
  if (not lep_sta_x2ondof_isLoaded) {
    ...
    if (doprintusage) cout << "lep_sta_x2ondof" << endl;
  }
  return *lep_sta_x2ondof_;
}

const vector<float> &CMS3::lep_glb_x2ondof() {
  if (not lep_glb_x2ondof_isLoaded) {
    ...
    if (doprintusage) cout << "lep_glb_x2ondof" << endl;
  }
  return *lep_glb_x2ondof_;
}

const vector<float> &CMS3::lep_exp_innerlayers() {
  if (not lep_exp_innerlayers_isLoaded) {
    if (lep_exp_innerlayers_branch != 0) {
      lep_exp_innerlayers_branch->GetEntry(index);
    } else {
      printf("branch lep_exp_innerlayers_branch does not exist!\n");
      exit(1);
    }
    lep_exp_innerlayers_isLoaded = true;
    if (doprintusage) cout << "lep_exp_innerlayers" << endl;
  }
  return *lep_exp_innerlayers_;
}

const vector<float> &CMS3::lep_exp_outerlayers() {
  if (not lep_exp_outerlayers_isLoaded) {
    if (lep_exp_outerlayers_branch != 0) {
      lep_exp_outerlayers_branch->GetEntry(index);
    } else {
      printf("branch lep_exp_outerlayers_branch does not exist!\n");
      exit(1);
    }
    lep_exp_outerlayers_isLoaded = true;
    if (doprintusage) cout << "lep_exp_outerlayers" << endl;
  }
  return *lep_exp_outerlayers_;
}

const vector<int> &CMS3::lep_nlayers() {
  if (not lep_nlayers_isLoaded) {
    ...
    if (doprintusage) cout << "lep_nlayers" << endl;
  }
  return *lep_nlayers_;
}

const vector<int> &CMS3::lep_type() {
  if (not lep_type_isLoaded) {
    ...
    if (doprintusage) cout << "lep_type" << endl;
  }
  return *lep_type_;
}

const vector<int> &CMS3::lep_validHits() {
  if (not lep_validHits_isLoaded) {
    if (lep_validHits_branch != 0) {
      lep_validHits_branch->GetEntry(index);
    } else {
      printf("branch lep_validHits_branch does not exist!\n");
      exit(1);
    }
    lep_validHits_isLoaded = true;
    if (doprintusage) cout << "lep_validHits" << endl;
  }
  return *lep_validHits_;
}

const vector<float> &CMS3::lep_dEtaIn_e() {
  if (not lep_dEtaIn_e_isLoaded) {
    if (lep_dEtaIn_e_branch != 0) {
      lep_dEtaIn_e_branch->GetEntry(index);
    } else {
      printf("branch lep_dEtaIn_e_branch does not exist!\n");
      exit(1);
    }
    lep_dEtaIn_e_isLoaded = true;
    if (doprintusage) cout << "lep_dEtaIn_e" << endl;
  }
  return *lep_dEtaIn_e_;
}

const vector<float> &CMS3::lep_dEtaOut_e() {
  if (not lep_dEtaOut_e_isLoaded) {
    if (lep_dEtaOut_e_branch != 0) {
      lep_dEtaOut_e_branch->GetEntry(index);
    } else {
      printf("branch lep_dEtaOut_e_branch does not exist!\n");
      exit(1);
    }
    lep_dEtaOut_e_isLoaded = true;
    if (doprintusage) cout << "lep_dEtaOut_e" << endl;
  }
  return *lep_dEtaOut_e_;
}

const vector<float> &CMS3::lep_dPhiIn_e() {
  if (not lep_dPhiIn_e_isLoaded) {
    if (lep_dPhiIn_e_branch != 0) {
      lep_dPhiIn_e_branch->GetEntry(index);
    } else {
      printf("branch lep_dPhiIn_e_branch does not exist!\n");
      exit(1);
    }
    lep_dPhiIn_e_isLoaded = true;
    if (doprintusage) cout << "lep_dPhiIn_e" << endl;
  }
  return *lep_dPhiIn_e_;
}

const vector<float> &CMS3::lep_ecalEnergy_e() {
  if (not lep_ecalEnergy_e_isLoaded) {
    if (lep_ecalEnergy_e_branch != 0) {
      lep_ecalEnergy_e_branch->GetEntry(index);
    } else {
      printf("branch lep_ecalEnergy_e_branch does not exist!\n");
      exit(1);
    }
    lep_ecalEnergy_e_isLoaded = true;
    if (doprintusage) cout << "lep_ecalEnergy_e" << endl;
  }
  return *lep_ecalEnergy_e_;
}

const vector<float> &CMS3::lep_ecalEnergyError_e() {
  if (not lep_ecalEnergyError_e_isLoaded) {
    if (lep_ecalEnergyError_e_branch != 0) {
      lep_ecalEnergyError_e_branch->GetEntry(index);
    } else {
      printf("branch lep_ecalEnergyError_e_branch does not exist!\n");
      exit(1);
    }
    lep_ecalEnergyError_e_isLoaded = true;
    if (doprintusage) cout << "lep_ecalEnergyError_e" << endl;
  }
  return *lep_ecalEnergyError_e_;
}

const vector<float> &CMS3::lep_ecalPFClusterIso_e() {
  if (not lep_ecalPFClusterIso_e_isLoaded) {
    if (lep_ecalPFClusterIso_e_branch != 0) {
      lep_ecalPFClusterIso_e_branch->GetEntry(index);
    } else {
      printf("branch lep_ecalPFClusterIso_e_branch does not exist!\n");
      exit(1);
    }
    lep_ecalPFClusterIso_e_isLoaded = true;
    if (doprintusage) cout << "lep_ecalPFClusterIso_e" << endl;
  }
  return *lep_ecalPFClusterIso_e_;
}

const vector<float> &CMS3::lep_eOverPIn_e() {
  if (not lep_eOverPIn_e_isLoaded) {
    if (lep_eOverPIn_e_branch != 0) {
      lep_eOverPIn_e_branch->GetEntry(index);
    } else {
      printf("branch lep_eOverPIn_e_branch does not exist!\n");
      exit(1);
    }
    lep_eOverPIn_e_isLoaded = true;
    if (doprintusage) cout << "lep_eOverPIn_e" << endl;
  }
  return *lep_eOverPIn_e_;
}

const vector<float> &CMS3::lep_hcalPFClusterIso_e() {
  if (not lep_hcalPFClusterIso_e_isLoaded) {
    if (lep_hcalPFClusterIso_e_branch != 0) {
      lep_hcalPFClusterIso_e_branch->GetEntry(index);
    } else {
      printf("branch lep_hcalPFClusterIso_e_branch does not exist!\n");
      exit(1);
    }
    lep_hcalPFClusterIso_e_isLoaded = true;
    if (doprintusage) cout << "lep_hcalPFClusterIso_e" << endl;
  }
  return *lep_hcalPFClusterIso_e_;
}

const vector<float> &CMS3::lep_hOverE_e() {
  if (not lep_hOverE_e_isLoaded) {
    if (lep_hOverE_e_branch != 0) {
      lep_hOverE_e_branch->GetEntry(index);
    } else {
      printf("branch lep_hOverE_e_branch does not exist!\n");
      exit(1);
    }
    lep_hOverE_e_isLoaded = true;
    if (doprintusage) cout << "lep_hOverE_e" << endl;
  }
  return *lep_hOverE_e_;
}

const vector<float> &CMS3::lep_scSeedEta_e() {
  if (not lep_scSeedEta_e_isLoaded) {
    if (lep_scSeedEta_e_branch != 0) {
      lep_scSeedEta_e_branch->GetEntry(index);
    } else {
      printf("branch lep_scSeedEta_e_branch does not exist!\n");
      exit(1);
    }
    lep_scSeedEta_e_isLoaded = true;
    if (doprintusage) cout << "lep_scSeedEta_e" << endl;
  }
  return *lep_scSeedEta_e_;
}

const vector<float> &CMS3::lep_sigmaIEtaIEta_full5x5_e() {
  if (not lep_sigmaIEtaIEta_full5x5_e_isLoaded) {
    if (lep_sigmaIEtaIEta_full5x5_e_branch != 0) {
      lep_sigmaIEtaIEta_full5x5_e_branch->GetEntry(index);
    } else {
      printf("branch lep_sigmaIEtaIEta_full5x5_e_branch does not exist!\n");
      exit(1);
    }
    lep_sigmaIEtaIEta_full5x5_e_isLoaded = true;
    if (doprintusage) cout << "lep_sigmaIEtaIEta_full5x5_e" << endl;
  }
  return *lep_sigmaIEtaIEta_full5x5_e_;
}

const vector<float> &CMS3::lep_tkIso_e() {
  if (not lep_tkIso_e_isLoaded) {
    if (lep_tkIso_e_branch != 0) {
      lep_tkIso_e_branch->GetEntry(index);
    } else {
      printf("branch lep_tkIso_e_branch does not exist!\n");
      exit(1);
    }
    lep_tkIso_e_isLoaded = true;
    if (doprintusage) cout << "lep_tkIso_e" << endl;
  }
  return *lep_tkIso_e_;
}

const vector<int> &CMS3::lep_goodGlb_m() {
  if (not lep_goodGlb_m_isLoaded) {
    if (lep_goodGlb_m_branch != 0) {
      lep_goodGlb_m_branch->GetEntry(index);
    } else {
      printf("branch lep_goodGlb_m_branch does not exist!\n");
      exit(1);
    }
    lep_goodGlb_m_isLoaded = true;
    if (doprintusage) cout << "lep_goodGlb_m" << endl;
  }
  return *lep_goodGlb_m_;
}

const vector<int> &CMS3::lep_isGlobal_m() {
  if (not lep_isGlobal_m_isLoaded) {
    if (lep_isGlobal_m_branch != 0) {
      lep_isGlobal_m_branch->GetEntry(index);
    } else {
      printf("branch lep_isGlobal_m_branch does not exist!\n");
      exit(1);
    }
    lep_isGlobal_m_isLoaded = true;
    if (doprintusage) cout << "lep_isGlobal_m" << endl;
  }
  return *lep_isGlobal_m_;
}

const vector<int> &CMS3::lep_isTracker_m() {
  if (not lep_isTracker_m_isLoaded) {
    if (lep_isTracker_m_branch != 0) {
      lep_isTracker_m_branch->GetEntry(index);
    } else {
      printf("branch lep_isTracker_m_branch does not exist!\n");
      exit(1);
    }
    lep_isTracker_m_isLoaded = true;
    if (doprintusage) cout << "lep_isTracker_m" << endl;
  }
  return *lep_isTracker_m_;
}

const vector<int> &CMS3::lep_gfit_ndof_m() {
  if (not lep_gfit_ndof_m_isLoaded) {
    if (lep_gfit_ndof_m_branch != 0) {
      lep_gfit_ndof_m_branch->GetEntry(index);
    } else {
      printf("branch lep_gfit_ndof_m_branch does not exist!\n");
      exit(1);
    }
    lep_gfit_ndof_m_isLoaded = true;
    if (doprintusage) cout << "lep_gfit_ndof_m" << endl;
  }
  return *lep_gfit_ndof_m_;
}

const vector<float> &CMS3::lep_chi2LocalPosition_m() {
  if (not lep_chi2LocalPosition_m_isLoaded) {
    if (lep_chi2LocalPosition_m_branch != 0) {
      lep_chi2LocalPosition_m_branch->GetEntry(index);
    } else {
      printf("branch lep_chi2LocalPosition_m_branch does not exist!\n");
      exit(1);
    }
    lep_chi2LocalPosition_m_isLoaded = true;
    if (doprintusage) cout << "lep_chi2LocalPosition_m" << endl;
  }
  return *lep_chi2LocalPosition_m_;
}

const vector<float> &CMS3::lep_gfit_chi2_m() {
  if (not lep_gfit_chi2_m_isLoaded) {
    if (lep_gfit_chi2_m_branch != 0) {
      lep_gfit_chi2_m_branch->GetEntry(index);
    } else {
      printf("branch lep_gfit_chi2_m_branch does not exist!\n");
      exit(1);
    }
    lep_gfit_chi2_m_isLoaded = true;
    if (doprintusage) cout << "lep_gfit_chi2_m" << endl;
  }
  return *lep_gfit_chi2_m_;
}

const vector<int> &CMS3::lep_gfit_validSTAHits_m() {
  if (not lep_gfit_validSTAHits_m_isLoaded) {
    if (lep_gfit_validSTAHits_m_branch != 0) {
      lep_gfit_validSTAHits_m_branch->GetEntry(index);
    } else {
      printf("branch lep_gfit_validSTAHits_m_branch does not exist!\n");
      exit(1);
    }
    lep_gfit_validSTAHits_m_isLoaded = true;
    if (doprintusage) cout << "lep_gfit_validSTAHits_m" << endl;
  }
  return *lep_gfit_validSTAHits_m_;
}

const vector<int> &CMS3::lep_numberOfMatchedStations_m() {
  if (not lep_numberOfMatchedStations_m_isLoaded) {
    if (lep_numberOfMatchedStations_m_branch != 0) {
      lep_numberOfMatchedStations_m_branch->GetEntry(index);
    } else {
      printf("branch lep_numberOfMatchedStations_m_branch does not exist!\n");
      exit(1);
    }
    lep_numberOfMatchedStations_m_isLoaded = true;
    if (doprintusage) cout << "lep_numberOfMatchedStations_m" << endl;
  }
  return *lep_numberOfMatchedStations_m_;
}

const vector<int> &CMS3::lep_pid_PFMuon_m() {
  if (not lep_pid_PFMuon_m_isLoaded) {
    if (lep_pid_PFMuon_m_branch != 0) {
      lep_pid_PFMuon_m_branch->GetEntry(index);
    } else {
      printf("branch lep_pid_PFMuon_m_branch does not exist!\n");
      exit(1);
    }
    lep_pid_PFMuon_m_isLoaded = true;
    if (doprintusage) cout << "lep_pid_PFMuon_m" << endl;
  }
  return *lep_pid_PFMuon_m_;
}

const vector<float> &CMS3::lep_segmCompatibility_m() {
  if (not lep_segmCompatibility_m_isLoaded) {
    if (lep_segmCompatibility_m_branch != 0) {
      lep_segmCompatibility_m_branch->GetEntry(index);
    } else {
      printf("branch lep_segmCompatibility_m_branch does not exist!\n");
      exit(1);
    }
    lep_segmCompatibility_m_isLoaded = true;
    if (doprintusage) cout << "lep_segmCompatibility_m" << endl;
  }
  return *lep_segmCompatibility_m_;
}

const vector<float> &CMS3::lep_trkKink_m() {
  if (not lep_trkKink_m_isLoaded) {
    if (lep_trkKink_m_branch != 0) {
      lep_trkKink_m_branch->GetEntry(index);
    } else {
      printf("branch lep_trkKink_m_branch does not exist!\n");
      exit(1);
    }
    lep_trkKink_m_isLoaded = true;
    if (doprintusage) cout << "lep_trkKink_m" << endl;
  }
  return *lep_trkKink_m_;
}

const vector<int> &CMS3::lep_validPixelHits_m() {
  if (not lep_validPixelHits_m_isLoaded) {
    if (lep_validPixelHits_m_branch != 0) {
      lep_validPixelHits_m_branch->GetEntry(index);
    } else {
      printf("branch lep_validPixelHits_m_branch does not exist!\n");
      exit(1);
    }
    lep_validPixelHits_m_isLoaded = true;
    if (doprintusage) cout << "lep_validPixelHits_m" << endl;
  }
  return *lep_validPixelHits_m_;
}

const int &CMS3::nisoTrack_5gev() {
  if (not nisoTrack_5gev_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_5gev" << endl;
  }
  return nisoTrack_5gev_;
}

const int &CMS3::nisoTrack_mt2() {
  if (not nisoTrack_mt2_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2" << endl;
  }
...
const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_veto() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_veto_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_veto" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_veto_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_veto_bak1() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_veto_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_veto_bak1" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_veto_bak1_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_bak1() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_bak1" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_bak1_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip_bak1() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip_bak1_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip_bak1" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip_bak1_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_fo() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_fo_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_fo" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_fo_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_fo_noiso() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_fo_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_fo_noiso" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_fo_noiso_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_tight_noiso() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_tight_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_tight_noiso" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_tight_noiso_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_cutbased_tight() {
  if (not nisoTrack_mt2_cleaned_VVV_cutbased_tight_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_cutbased_tight" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_cutbased_tight_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_MVAbased_tight_noiso() {
  if (not nisoTrack_mt2_cleaned_VVV_MVAbased_tight_noiso_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_MVAbased_tight_noiso" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_MVAbased_tight_noiso_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_MVAbased_tight() {
  if (not nisoTrack_mt2_cleaned_VVV_MVAbased_tight_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_MVAbased_tight" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_MVAbased_tight_;
}

const int &CMS3::nisoTrack_mt2_cleaned_VVV_baseline() {
  if (not nisoTrack_mt2_cleaned_VVV_baseline_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_mt2_cleaned_VVV_baseline" << endl;
  }
  return nisoTrack_mt2_cleaned_VVV_baseline_;
}

const int &CMS3::nisoTrack_stop() {
  if (not nisoTrack_stop_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_stop" << endl;
  }
  return nisoTrack_stop_;
}

const int &CMS3::nisoTrack_PFLep5_woverlaps() {
  if (not nisoTrack_PFLep5_woverlaps_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_PFLep5_woverlaps" << endl;
  }
  return nisoTrack_PFLep5_woverlaps_;
}

const int &CMS3::nisoTrack_PFHad10_woverlaps() {
  if (not nisoTrack_PFHad10_woverlaps_isLoaded) {
    ...
    if (doprintusage) cout << "nisoTrack_PFHad10_woverlaps" << endl;
  }
...
const int &CMS3::ngamma() {
  if (not ngamma_isLoaded) {
    ...
    if (doprintusage) cout << "ngamma" << endl;
  }
  return ngamma_;
}

const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::gamma_p4() {
  if (not gamma_p4_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_p4" << endl;
  }
  return *gamma_p4_;
}

const vector<float> &CMS3::gamma_pt() {
  if (not gamma_pt_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_pt" << endl;
  }
  return *gamma_pt_;
}

const vector<float> &CMS3::gamma_eta() {
  if (not gamma_eta_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_eta" << endl;
  }
  return *gamma_eta_;
}

const vector<float> &CMS3::gamma_phi() {
  if (not gamma_phi_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_phi" << endl;
  }
  return *gamma_phi_;
}

const vector<float> &CMS3::gamma_mass() {
  if (not gamma_mass_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_mass" << endl;
  }
  return *gamma_mass_;
}

const vector<int> &CMS3::gamma_mcMatchId() {
  if (not gamma_mcMatchId_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_mcMatchId" << endl;
  }
  return *gamma_mcMatchId_;
}

const vector<float> &CMS3::gamma_genPt() {
  if (not gamma_genPt_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_genPt" << endl;
  }
  return *gamma_genPt_;
}

const vector<float> &CMS3::gamma_genIso() {
  if (not gamma_genIso_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_genIso" << endl;
  }
  return *gamma_genIso_;
}

const vector<float> &CMS3::gamma_chHadIso() {
  if (not gamma_chHadIso_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_chHadIso" << endl;
  }
  return *gamma_chHadIso_;
}

const vector<float> &CMS3::gamma_neuHadIso() {
  if (not gamma_neuHadIso_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_neuHadIso" << endl;
  }
  return *gamma_neuHadIso_;
}

const vector<float> &CMS3::gamma_phIso() {
  if (not gamma_phIso_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_phIso" << endl;
  }
  return *gamma_phIso_;
}

const vector<float> &CMS3::gamma_sigmaIetaIeta() {
  if (not gamma_sigmaIetaIeta_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_sigmaIetaIeta" << endl;
  }
  return *gamma_sigmaIetaIeta_;
}

const vector<float> &CMS3::gamma_r9() {
  if (not gamma_r9_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_r9" << endl;
  }
  return *gamma_r9_;
}

const vector<float> &CMS3::gamma_hOverE() {
  if (not gamma_hOverE_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_hOverE" << endl;
  }
  return *gamma_hOverE_;
}

const vector<float> &CMS3::gamma_hOverE_online() {
  if (not gamma_hOverE_online_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_hOverE_online" << endl;
  }
  return *gamma_hOverE_online_;
}

const vector<int> &CMS3::gamma_idCutBased() {
  if (not gamma_idCutBased_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_idCutBased" << endl;
  }
  return *gamma_idCutBased_;
}

const vector<float> &CMS3::gamma_ecpfclusiso() {
  if (not gamma_ecpfclusiso_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_ecpfclusiso" << endl;
  }
  return *gamma_ecpfclusiso_;
}

const vector<float> &CMS3::gamma_hcpfclusiso() {
  if (not gamma_hcpfclusiso_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_hcpfclusiso" << endl;
  }
  return *gamma_hcpfclusiso_;
}

const vector<float> &CMS3::gamma_hollowtkiso03() {
  if (not gamma_hollowtkiso03_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_hollowtkiso03" << endl;
  }
  return *gamma_hollowtkiso03_;
}

const vector<int> &CMS3::gamma_genIsPromptFinalState() {
  if (not gamma_genIsPromptFinalState_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_genIsPromptFinalState" << endl;
  }
  return *gamma_genIsPromptFinalState_;
}

const vector<float> &CMS3::gamma_drMinParton() {
  if (not gamma_drMinParton_isLoaded) {
    ...
    if (doprintusage) cout << "gamma_drMinParton" << endl;
  }
  return *gamma_drMinParton_;
}

const int &CMS3::ngenPart() {
  if (not ngenPart_isLoaded) {
    ...
    if (doprintusage) cout << "ngenPart" << endl;
  }
  return ngenPart_;
}
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::genPart_p4() {
  if (not genPart_p4_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_p4" << endl;
  }
  return *genPart_p4_;
}

const vector<float> &CMS3::genPart_pt() {
  if (not genPart_pt_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_pt" << endl;
  }
  return *genPart_pt_;
}

const vector<float> &CMS3::genPart_eta() {
  if (not genPart_eta_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_eta" << endl;
  }
  return *genPart_eta_;
}

const vector<float> &CMS3::genPart_phi() {
  if (not genPart_phi_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_phi" << endl;
  }
  return *genPart_phi_;
}

const vector<float> &CMS3::genPart_mass() {
  if (not genPart_mass_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_mass" << endl;
  }
...
const vector<int> &CMS3::genPart_pdgId() {
  if (not genPart_pdgId_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_pdgId" << endl;
  }
...
const vector<int> &CMS3::genPart_status() {
  if (not genPart_status_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_status" << endl;
  }
...
const vector<int> &CMS3::genPart_charge() {
  if (not genPart_charge_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_charge" << endl;
  }
...
const vector<int> &CMS3::genPart_motherId() {
  if (not genPart_motherId_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_motherId" << endl;
  }
  return *genPart_motherId_;
}

const vector<int> &CMS3::genPart_grandmaId() {
  if (not genPart_grandmaId_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_grandmaId" << endl;
  }
  return *genPart_grandmaId_;
}

const vector<int> &CMS3::genPart_isp6status3() {
  if (not genPart_isp6status3_isLoaded) {
    ...
    if (doprintusage) cout << "genPart_isp6status3" << endl;
  }
...
const int &CMS3::ngenLep() {
  if (not ngenLep_isLoaded) {
    ...
    if (doprintusage) cout << "ngenLep" << endl;
  }
  return ngenLep_;
}

const vector<float> &CMS3::genLep_pt() {
  if (not genLep_pt_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_pt" << endl;
  }
  return *genLep_pt_;
}

const vector<float> &CMS3::genLep_eta() {
  if (not genLep_eta_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_eta" << endl;
  }
  return *genLep_eta_;
}

const vector<float> &CMS3::genLep_phi() {
  if (not genLep_phi_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_phi" << endl;
  }
  return *genLep_phi_;
}

const vector<float> &CMS3::genLep_mass() {
  if (not genLep_mass_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_mass" << endl;
  }
  return *genLep_mass_;
}

const vector<int> &CMS3::genLep_pdgId() {
  if (not genLep_pdgId_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_pdgId" << endl;
  }
  return *genLep_pdgId_;
}

const vector<int> &CMS3::genLep_status() {
  if (not genLep_status_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_status" << endl;
  }
  return *genLep_status_;
}

const vector<float> &CMS3::genLep_charge() {
  if (not genLep_charge_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_charge" << endl;
  }
  return *genLep_charge_;
}

const vector<int> &CMS3::genLep_sourceId() {
  if (not genLep_sourceId_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_sourceId" << endl;
  }
  return *genLep_sourceId_;
}

const vector<int> &CMS3::genLep_isp6status3() {
  if (not genLep_isp6status3_isLoaded) {
    ...
    if (doprintusage) cout << "genLep_isp6status3" << endl;
  }
  return *genLep_isp6status3_;
}

const int &CMS3::ngenTau() {
  if (not ngenTau_isLoaded) {
    ...
    if (doprintusage) cout << "ngenTau" << endl;
  }
  return ngenTau_;
}

const vector<float> &CMS3::genTau_pt() {
  if (not genTau_pt_isLoaded) {
    ...
    if (doprintusage) cout << "genTau_pt" << endl;
  }
  return *genTau_pt_;
}

const vector<float> &CMS3::genTau_eta() {
  if (not genTau_eta_isLoaded) {
    ...
    if (doprintusage) cout << "genTau_eta" << endl;
  }
  return *genTau_eta_;
}

const vector<float> &CMS3::genTau_phi() {
  if (not genTau_phi_isLoaded) {
    ...
    if (doprintusage) cout << "genTau_phi" << endl;
  }
  return *genTau_phi_;
}

const vector<float> &CMS3::genTau_mass() {
  if (not genTau_mass_isLoaded) {
    ...
    if (doprintusage) cout << "genTau_mass" << endl;
  }
  return *genTau_mass_;
}

const vector<int> &CMS3::genTau_pdgId() {
  if (not genTau_pdgId_isLoaded) {
    ...
    if (doprintusage) cout << "genTau_pdgId" << endl;
  }
  return *genTau_pdgId_;
}

const vector<int> &CMS3::genTau_status() {
  if (not genTau_status_isLoaded) {
    ...
    if (doprintusage) cout << "genTau_status" << endl;
  }
  return *genTau_status_;
}

const vector<float> &CMS3::genTau_charge() {
  if (not genTau_charge_isLoaded) {
    ...
    if (doprintusage) cout << "genTau_charge" << endl;
  }
  return *genTau_charge_;
}

const vector<int> &CMS3::genTau_sourceId() {
  if (not genTau_sourceId_isLoaded) {
    ...
    if (doprintusage) cout << "genTau_sourceId" << endl;
  }
...
const int &CMS3::ngenLepFromTau() {
  if (not ngenLepFromTau_isLoaded) {
    ...
    if (doprintusage) cout << "ngenLepFromTau" << endl;
  }
  return ngenLepFromTau_;
}

const vector<float> &CMS3::genLepFromTau_pt() {
  if (not genLepFromTau_pt_isLoaded) {
    ...
    if (doprintusage) cout << "genLepFromTau_pt" << endl;
  }
  return *genLepFromTau_pt_;
}

const vector<float> &CMS3::genLepFromTau_eta() {
  if (not genLepFromTau_eta_isLoaded) {
    ...
    if (doprintusage) cout << "genLepFromTau_eta" << endl;
  }
  return *genLepFromTau_eta_;
}

const vector<float> &CMS3::genLepFromTau_phi() {
  if (not genLepFromTau_phi_isLoaded) {
    ...
    if (doprintusage) cout << "genLepFromTau_phi" << endl;
  }
  return *genLepFromTau_phi_;
}

const vector<float> &CMS3::genLepFromTau_mass() {
  if (not genLepFromTau_mass_isLoaded) {
    ...
    if (doprintusage) cout << "genLepFromTau_mass" << endl;
  }
  return *genLepFromTau_mass_;
}

const vector<int> &CMS3::genLepFromTau_pdgId() {
  if (not genLepFromTau_pdgId_isLoaded) {
    ...
    if (doprintusage) cout << "genLepFromTau_pdgId" << endl;
  }
  return *genLepFromTau_pdgId_;
}

const vector<int> &CMS3::genLepFromTau_status() {
  if (not genLepFromTau_status_isLoaded) {
    ...
    if (doprintusage) cout << "genLepFromTau_status" << endl;
  }
  return *genLepFromTau_status_;
}

const vector<float> &CMS3::genLepFromTau_charge() {
  if (not genLepFromTau_charge_isLoaded) {
    ...
    if (doprintusage) cout << "genLepFromTau_charge" << endl;
  }
  return *genLepFromTau_charge_;
}

const vector<int> &CMS3::genLepFromTau_sourceId() {
  if (not genLepFromTau_sourceId_isLoaded) {
    ...
    if (doprintusage) cout << "genLepFromTau_sourceId" << endl;
  }
...
const int &CMS3::njets() {
  if (not njets_isLoaded) {
    ...
    njets_isLoaded = true;
    if (doprintusage) cout << "njets" << endl;
  }
  return njets_;
}
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::jets_p4() {
  if (not jets_p4_isLoaded) {
    ...
    if (doprintusage) cout << "jets_p4" << endl;
  }
  return *jets_p4_;
}

const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::removed_jets_p4() {
  if (not removed_jets_p4_isLoaded) {
    ...
    if (doprintusage) cout << "removed_jets_p4" << endl;
  }
  return *removed_jets_p4_;
}

const vector<float> &CMS3::removed_jets_csv() {
  if (not removed_jets_csv_isLoaded) {
    ...
    if (doprintusage) cout << "removed_jets_csv" << endl;
  }
  return *removed_jets_csv_;
}

const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::jets_medb_p4() {
  if (not jets_medb_p4_isLoaded) {
    ...
    if (doprintusage) cout << "jets_medb_p4" << endl;
  }
  return *jets_medb_p4_;
}

const int &CMS3::njets_up() {
  if (not njets_up_isLoaded) {
    ...
    if (doprintusage) cout << "njets_up" << endl;
  }
  return njets_up_;
}
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::jets_up_p4() {
  if (not jets_up_p4_isLoaded) {
    ...
    if (doprintusage) cout << "jets_up_p4" << endl;
  }
  return *jets_up_p4_;
}

const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::jets_medb_up_p4() {
  if (not jets_medb_up_p4_isLoaded) {
    ...
    if (doprintusage) cout << "jets_medb_up_p4" << endl;
  }
...
const vector<float> &CMS3::jets_csv() {
  if (not jets_csv_isLoaded) {
    ...
    if (doprintusage) cout << "jets_csv" << endl;
  }
  return *jets_csv_;
}
...
const vector<float> &CMS3::jets_up_csv() {
  if (not jets_up_csv_isLoaded) {
    ...
    if (doprintusage) cout << "jets_up_csv" << endl;
  }
  return *jets_up_csv_;
}

const int &CMS3::njets_dn() {
  if (not njets_dn_isLoaded) {
    ...
    if (doprintusage) cout << "njets_dn" << endl;
  }
  return njets_dn_;
}
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::jets_dn_p4() {
  if (not jets_dn_p4_isLoaded) {
    ...
    if (doprintusage) cout << "jets_dn_p4" << endl;
  }
  return *jets_dn_p4_;
}

const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::jets_medb_dn_p4() {
  if (not jets_medb_dn_p4_isLoaded) {
    ...
    if (doprintusage) cout << "jets_medb_dn_p4" << endl;
  }
...
const vector<float> &CMS3::jets_dn_csv() {
  if (not jets_dn_csv_isLoaded) {
    ...
    if (doprintusage) cout << "jets_dn_csv" << endl;
  }
  return *jets_dn_csv_;
}

const vector<float> &CMS3::jets_muf() {
  if (not jets_muf_isLoaded) {
    ...
    if (doprintusage) cout << "jets_muf" << endl;
  }
  return *jets_muf_;
}

const vector<int> &CMS3::jets_mcFlavour() {
  if (not jets_mcFlavour_isLoaded) {
    ...
    if (doprintusage) cout << "jets_mcFlavour" << endl;
  }
  return *jets_mcFlavour_;
}

const vector<int> &CMS3::jets_mcHadronFlav() {
  if (not jets_mcHadronFlav_isLoaded) {
    ...
    if (doprintusage) cout << "jets_mcHadronFlav" << endl;
  }
...
const int &CMS3::nhighPtPFcands() {
  if (not nhighPtPFcands_isLoaded) {
    ...
    if (doprintusage) cout << "nhighPtPFcands" << endl;
  }
  return nhighPtPFcands_;
}

const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &CMS3::highPtPFcands_p4() {
  if (not highPtPFcands_p4_isLoaded) {
    ...
    if (doprintusage) cout << "highPtPFcands_p4" << endl;
  }
  return *highPtPFcands_p4_;
}

const vector<float> &CMS3::highPtPFcands_dz() {
  if (not highPtPFcands_dz_isLoaded) {
    ...
    if (doprintusage) cout << "highPtPFcands_dz" << endl;
  }
  return *highPtPFcands_dz_;
}

const vector<int> &CMS3::highPtPFcands_pdgId() {
  if (not highPtPFcands_pdgId_isLoaded) {
    ...
    if (doprintusage) cout << "highPtPFcands_pdgId" << endl;
  }
...
const float &CMS3::ht() {
  if (not ht_isLoaded) {
    ...
    ht_isLoaded = true;
    if (doprintusage) cout << "ht" << endl;
  }
  return ht_;
}

const float &CMS3::ht_up() {
  if (not ht_up_isLoaded) {
    ...
    ht_up_isLoaded = true;
    if (doprintusage) cout << "ht_up" << endl;
  }
  return ht_up_;
}

const float &CMS3::ht_dn() {
  if (not ht_dn_isLoaded) {
    ...
    ht_dn_isLoaded = true;
    if (doprintusage) cout << "ht_dn" << endl;
  }
  return ht_dn_;
}

const float &CMS3::metsig_unofficial() {
  if (not metsig_unofficial_isLoaded) {
    ...
    if (doprintusage) cout << "metsig_unofficial" << endl;
  }
  return metsig_unofficial_;
}

const float &CMS3::metsig_unofficial_up() {
  if (not metsig_unofficial_up_isLoaded) {
    ...
    if (doprintusage) cout << "metsig_unofficial_up" << endl;
  }
  return metsig_unofficial_up_;
}

const float &CMS3::metsig_unofficial_dn() {
  if (not metsig_unofficial_dn_isLoaded) {
    ...
    if (doprintusage) cout << "metsig_unofficial_dn" << endl;
  }
  return metsig_unofficial_dn_;
}

const float &CMS3::mt_lep1() {
  if (not mt_lep1_isLoaded) {
    ...
    if (doprintusage) cout << "mt_lep1" << endl;
  }
  return mt_lep1_;
}
...
const float &CMS3::mt2() {
  if (not mt2_isLoaded) {
    ...
    mt2_isLoaded = true;
    if (doprintusage) cout << "mt2" << endl;
  }
  return mt2_;
}

const float &CMS3::mt2_up() {
  if (not mt2_up_isLoaded) {
    ...
    if (doprintusage) cout << "mt2_up" << endl;
  }
  return mt2_up_;
}

const float &CMS3::mt2_dn() {
  if (not mt2_dn_isLoaded) {
    ...
    if (doprintusage) cout << "mt2_dn" << endl;
  }
  return mt2_dn_;
}

const float &CMS3::mt2j() {
  if (not mt2j_isLoaded) {
    ...
    mt2j_isLoaded = true;
    if (doprintusage) cout << "mt2j" << endl;
  }
  return mt2j_;
}

const float &CMS3::mt2b() {
  if (not mt2b_isLoaded) {
    ...
    mt2b_isLoaded = true;
    if (doprintusage) cout << "mt2b" << endl;
  }
  return mt2b_;
}

const float &CMS3::mt2b_up() {
  if (not mt2b_up_isLoaded) {
    ...
    if (doprintusage) cout << "mt2b_up" << endl;
  }
  return mt2b_up_;
}

const float &CMS3::mt2b_dn() {
  if (not mt2b_dn_isLoaded) {
    ...
    if (doprintusage) cout << "mt2b_dn" << endl;
  }
  return mt2b_dn_;
}
...
const float &CMS3::mt2_genmet() {
  if (not mt2_genmet_isLoaded) {
    ...
    if (doprintusage) cout << "mt2_genmet" << endl;
  }
  return mt2_genmet_;
}

const float &CMS3::mt2b_genmet() {
  if (not mt2b_genmet_isLoaded) {
    ...
    if (doprintusage) cout << "mt2b_genmet" << endl;
  }
  return mt2b_genmet_;
}

const float &CMS3::mjj_mindphi() {
  if (not mjj_mindphi_isLoaded) {
    ...
    if (doprintusage) cout << "mjj_mindphi" << endl;
  }
  return mjj_mindphi_;
}
...
const float &CMS3::mjj() {
  if (not mjj_isLoaded) {
    ...
    mjj_isLoaded = true;
    if (doprintusage) cout << "mjj" << endl;
  }
  return mjj_;
}

const float &CMS3::mbb_csv() {
  if (not mbb_csv_isLoaded) {
    ...
    if (doprintusage) cout << "mbb_csv" << endl;
  }
  return mbb_csv_;
}

const float &CMS3::mbb_bpt() {
  if (not mbb_bpt_isLoaded) {
    ...
    if (doprintusage) cout << "mbb_bpt" << endl;
  }
  return mbb_bpt_;
}

const float &CMS3::dphi_jj() {
  if (not dphi_jj_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_jj" << endl;
  }
  return dphi_jj_;
}

const float &CMS3::dphi_ll() {
  if (not dphi_ll_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_ll" << endl;
  }
  return dphi_ll_;
}

const float &CMS3::sum_mlb() {
  if (not sum_mlb_isLoaded) {
    ...
    if (doprintusage) cout << "sum_mlb" << endl;
  }
  return sum_mlb_;
}

const float &CMS3::deta_jj() {
  if (not deta_jj_isLoaded) {
    ...
    if (doprintusage) cout << "deta_jj" << endl;
  }
  return deta_jj_;
}

const float &CMS3::dR_jj() {
  if (not dR_jj_isLoaded) {
    ...
    dR_jj_isLoaded = true;
    if (doprintusage) cout << "dR_jj" << endl;
  }
  return dR_jj_;
}

const float &CMS3::dphi_metj1() {
  if (not dphi_metj1_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_metj1" << endl;
  }
  return dphi_metj1_;
}

const float &CMS3::dphi_metj2() {
  if (not dphi_metj2_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_metj2" << endl;
  }
  return dphi_metj2_;
}

const float &CMS3::dphi_genmetj1() {
  if (not dphi_genmetj1_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_genmetj1" << endl;
  }
  return dphi_genmetj1_;
}

const float &CMS3::dphi_genmetj2() {
  if (not dphi_genmetj2_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_genmetj2" << endl;
  }
  return dphi_genmetj2_;
}

const float &CMS3::mjj_mindphi_up() {
  if (not mjj_mindphi_up_isLoaded) {
    ...
    if (doprintusage) cout << "mjj_mindphi_up" << endl;
  }
...
const float &CMS3::mjj_up() {
  if (not mjj_up_isLoaded) {
    ...
    if (doprintusage) cout << "mjj_up" << endl;
  }
  return mjj_up_;
}

const float &CMS3::mbb_csv_up() {
  if (not mbb_csv_up_isLoaded) {
    ...
    if (doprintusage) cout << "mbb_csv_up" << endl;
  }
  return mbb_csv_up_;
}

const float &CMS3::mbb_bpt_up() {
  if (not mbb_bpt_up_isLoaded) {
    ...
    if (doprintusage) cout << "mbb_bpt_up" << endl;
  }
  return mbb_bpt_up_;
}

const float &CMS3::dphi_jj_up() {
  if (not dphi_jj_up_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_jj_up" << endl;
  }
  return dphi_jj_up_;
}

const float &CMS3::dphi_ll_up() {
  if (not dphi_ll_up_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_ll_up" << endl;
  }
  return dphi_ll_up_;
}

const float &CMS3::sum_mlb_up() {
  if (not sum_mlb_up_isLoaded) {
    ...
    if (doprintusage) cout << "sum_mlb_up" << endl;
  }
  return sum_mlb_up_;
}

const float &CMS3::deta_jj_up() {
  if (not deta_jj_up_isLoaded) {
    ...
    if (doprintusage) cout << "deta_jj_up" << endl;
  }
  return deta_jj_up_;
}

const float &CMS3::dR_jj_up() {
  if (not dR_jj_up_isLoaded) {
    ...
    if (doprintusage) cout << "dR_jj_up" << endl;
  }
  return dR_jj_up_;
}

const float &CMS3::dphi_metj1_up() {
  if (not dphi_metj1_up_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_metj1_up" << endl;
  }
  return dphi_metj1_up_;
}

const float &CMS3::dphi_metj2_up() {
  if (not dphi_metj2_up_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_metj2_up" << endl;
  }
  return dphi_metj2_up_;
}

const float &CMS3::mjj_mindphi_dn() {
  if (not mjj_mindphi_dn_isLoaded) {
    ...
    if (doprintusage) cout << "mjj_mindphi_dn" << endl;
  }
...
const float &CMS3::mjj_dn() {
  if (not mjj_dn_isLoaded) {
    ...
    if (doprintusage) cout << "mjj_dn" << endl;
  }
  return mjj_dn_;
}

const float &CMS3::mbb_csv_dn() {
  if (not mbb_csv_dn_isLoaded) {
    ...
    if (doprintusage) cout << "mbb_csv_dn" << endl;
  }
  return mbb_csv_dn_;
}

const float &CMS3::mbb_bpt_dn() {
  if (not mbb_bpt_dn_isLoaded) {
    ...
    if (doprintusage) cout << "mbb_bpt_dn" << endl;
  }
  return mbb_bpt_dn_;
}

const float &CMS3::dphi_jj_dn() {
  if (not dphi_jj_dn_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_jj_dn" << endl;
  }
  return dphi_jj_dn_;
}

const float &CMS3::dphi_ll_dn() {
  if (not dphi_ll_dn_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_ll_dn" << endl;
  }
  return dphi_ll_dn_;
}

const float &CMS3::sum_mlb_dn() {
  if (not sum_mlb_dn_isLoaded) {
    ...
    if (doprintusage) cout << "sum_mlb_dn" << endl;
  }
  return sum_mlb_dn_;
}

const float &CMS3::deta_jj_dn() {
  if (not deta_jj_dn_isLoaded) {
    ...
    if (doprintusage) cout << "deta_jj_dn" << endl;
  }
  return deta_jj_dn_;
}

const float &CMS3::dR_jj_dn() {
  if (not dR_jj_dn_isLoaded) {
    ...
    if (doprintusage) cout << "dR_jj_dn" << endl;
  }
  return dR_jj_dn_;
}

const float &CMS3::dphi_metj1_dn() {
  if (not dphi_metj1_dn_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_metj1_dn" << endl;
  }
  return dphi_metj1_dn_;
}

const float &CMS3::dphi_metj2_dn() {
  if (not dphi_metj2_dn_isLoaded) {
    ...
    if (doprintusage) cout << "dphi_metj2_dn" << endl;
  }
...
const float &CMS3::weight_btagsf() {
  if (not weight_btagsf_isLoaded) {
    ...
    if (doprintusage) cout << "weight_btagsf" << endl;
  }
...
const float &CMS3::weight_btagsf_heavy_UP() {
  if (not weight_btagsf_heavy_UP_isLoaded) {
    ...
    if (doprintusage) cout << "weight_btagsf_heavy_UP" << endl;
  }
...
const float &CMS3::weight_btagsf_light_UP() {
  if (not weight_btagsf_light_UP_isLoaded) {
    ...
    if (doprintusage) cout << "weight_btagsf_light_UP" << endl;
  }
...
const float &CMS3::weight_btagsf_heavy_DN() {
  if (not weight_btagsf_heavy_DN_isLoaded) {
    ...
    if (doprintusage) cout << "weight_btagsf_heavy_DN" << endl;
  }
...
const float &CMS3::weight_btagsf_light_DN() {
  if (not weight_btagsf_light_DN_isLoaded) {
    ...
    if (doprintusage) cout << "weight_btagsf_light_DN" << endl;
  }
  return weight_btagsf_light_DN_;
}

const float &CMS3::chpfcands_0013_pt() {
  if (not chpfcands_0013_pt_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_0013_pt" << endl;
  }
  return chpfcands_0013_pt_;
}

const float &CMS3::chpfcands_1316_pt() {
  if (not chpfcands_1316_pt_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_1316_pt" << endl;
  }
  return chpfcands_1316_pt_;
}

const float &CMS3::chpfcands_1624_pt() {
  if (not chpfcands_1624_pt_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_1624_pt" << endl;
  }
  return chpfcands_1624_pt_;
}

const float &CMS3::chpfcands_2430_pt() {
  if (not chpfcands_2430_pt_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_2430_pt" << endl;
  }
  return chpfcands_2430_pt_;
}

const float &CMS3::chpfcands_30in_pt() {
  if (not chpfcands_30in_pt_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_30in_pt" << endl;
  }
  return chpfcands_30in_pt_;
}

const float &CMS3::phpfcands_0013_pt() {
  if (not phpfcands_0013_pt_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_0013_pt" << endl;
  }
  return phpfcands_0013_pt_;
}

const float &CMS3::phpfcands_1316_pt() {
  if (not phpfcands_1316_pt_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_1316_pt" << endl;
  }
  return phpfcands_1316_pt_;
}

const float &CMS3::phpfcands_1624_pt() {
  if (not phpfcands_1624_pt_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_1624_pt" << endl;
  }
  return phpfcands_1624_pt_;
}

const float &CMS3::phpfcands_2430_pt() {
  if (not phpfcands_2430_pt_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_2430_pt" << endl;
  }
  return phpfcands_2430_pt_;
}

const float &CMS3::phpfcands_30in_pt() {
  if (not phpfcands_30in_pt_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_30in_pt" << endl;
  }
  return phpfcands_30in_pt_;
}

const float &CMS3::nupfcands_0013_pt() {
  if (not nupfcands_0013_pt_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_0013_pt" << endl;
  }
  return nupfcands_0013_pt_;
}

const float &CMS3::nupfcands_1316_pt() {
  if (not nupfcands_1316_pt_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_1316_pt" << endl;
  }
  return nupfcands_1316_pt_;
}

const float &CMS3::nupfcands_1624_pt() {
  if (not nupfcands_1624_pt_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_1624_pt" << endl;
  }
  return nupfcands_1624_pt_;
}

const float &CMS3::nupfcands_2430_pt() {
  if (not nupfcands_2430_pt_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_2430_pt" << endl;
  }
  return nupfcands_2430_pt_;
}

const float &CMS3::nupfcands_30in_pt() {
  if (not nupfcands_30in_pt_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_30in_pt" << endl;
  }
  return nupfcands_30in_pt_;
}

const float &CMS3::chpfcands_0013_sumet() {
  if (not chpfcands_0013_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_0013_sumet" << endl;
  }
  return chpfcands_0013_sumet_;
}

const float &CMS3::chpfcands_1316_sumet() {
  if (not chpfcands_1316_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_1316_sumet" << endl;
  }
  return chpfcands_1316_sumet_;
}

const float &CMS3::chpfcands_1624_sumet() {
  if (not chpfcands_1624_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_1624_sumet" << endl;
  }
  return chpfcands_1624_sumet_;
}

const float &CMS3::chpfcands_2430_sumet() {
  if (not chpfcands_2430_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_2430_sumet" << endl;
  }
  return chpfcands_2430_sumet_;
}

const float &CMS3::chpfcands_30in_sumet() {
  if (not chpfcands_30in_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_30in_sumet" << endl;
  }
  return chpfcands_30in_sumet_;
}

const float &CMS3::phpfcands_0013_sumet() {
  if (not phpfcands_0013_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_0013_sumet" << endl;
  }
  return phpfcands_0013_sumet_;
}

const float &CMS3::phpfcands_1316_sumet() {
  if (not phpfcands_1316_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_1316_sumet" << endl;
  }
  return phpfcands_1316_sumet_;
}

const float &CMS3::phpfcands_1624_sumet() {
  if (not phpfcands_1624_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_1624_sumet" << endl;
  }
  return phpfcands_1624_sumet_;
}

const float &CMS3::phpfcands_2430_sumet() {
  if (not phpfcands_2430_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_2430_sumet" << endl;
  }
  return phpfcands_2430_sumet_;
}

const float &CMS3::phpfcands_30in_sumet() {
  if (not phpfcands_30in_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_30in_sumet" << endl;
  }
  return phpfcands_30in_sumet_;
}

const float &CMS3::nupfcands_0013_sumet() {
  if (not nupfcands_0013_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_0013_sumet" << endl;
  }
  return nupfcands_0013_sumet_;
}

const float &CMS3::nupfcands_1316_sumet() {
  if (not nupfcands_1316_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_1316_sumet" << endl;
  }
  return nupfcands_1316_sumet_;
}

const float &CMS3::nupfcands_1624_sumet() {
  if (not nupfcands_1624_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_1624_sumet" << endl;
  }
  return nupfcands_1624_sumet_;
}

const float &CMS3::nupfcands_2430_sumet() {
  if (not nupfcands_2430_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_2430_sumet" << endl;
  }
  return nupfcands_2430_sumet_;
}

const float &CMS3::nupfcands_30in_sumet() {
  if (not nupfcands_30in_sumet_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_30in_sumet" << endl;
  }
  return nupfcands_30in_sumet_;
}

const float &CMS3::chpfcands_0013_phi() {
  if (not chpfcands_0013_phi_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_0013_phi" << endl;
  }
  return chpfcands_0013_phi_;
}

const float &CMS3::chpfcands_1316_phi() {
  if (not chpfcands_1316_phi_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_1316_phi" << endl;
  }
  return chpfcands_1316_phi_;
}

const float &CMS3::chpfcands_1624_phi() {
  if (not chpfcands_1624_phi_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_1624_phi" << endl;
  }
  return chpfcands_1624_phi_;
}

const float &CMS3::chpfcands_2430_phi() {
  if (not chpfcands_2430_phi_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_2430_phi" << endl;
  }
  return chpfcands_2430_phi_;
}

const float &CMS3::chpfcands_30in_phi() {
  if (not chpfcands_30in_phi_isLoaded) {
    ...
    if (doprintusage) cout << "chpfcands_30in_phi" << endl;
  }
  return chpfcands_30in_phi_;
}

const float &CMS3::phpfcands_0013_phi() {
  if (not phpfcands_0013_phi_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_0013_phi" << endl;
  }
  return phpfcands_0013_phi_;
}

const float &CMS3::phpfcands_1316_phi() {
  if (not phpfcands_1316_phi_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_1316_phi" << endl;
  }
  return phpfcands_1316_phi_;
}

const float &CMS3::phpfcands_1624_phi() {
  if (not phpfcands_1624_phi_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_1624_phi" << endl;
  }
  return phpfcands_1624_phi_;
}

const float &CMS3::phpfcands_2430_phi() {
  if (not phpfcands_2430_phi_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_2430_phi" << endl;
  }
  return phpfcands_2430_phi_;
}

const float &CMS3::phpfcands_30in_phi() {
  if (not phpfcands_30in_phi_isLoaded) {
    ...
    if (doprintusage) cout << "phpfcands_30in_phi" << endl;
  }
  return phpfcands_30in_phi_;
}

const float &CMS3::nupfcands_0013_phi() {
  if (not nupfcands_0013_phi_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_0013_phi" << endl;
  }
  return nupfcands_0013_phi_;
}

const float &CMS3::nupfcands_1316_phi() {
  if (not nupfcands_1316_phi_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_1316_phi" << endl;
  }
  return nupfcands_1316_phi_;
}

const float &CMS3::nupfcands_1624_phi() {
  if (not nupfcands_1624_phi_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_1624_phi" << endl;
  }
  return nupfcands_1624_phi_;
}

const float &CMS3::nupfcands_2430_phi() {
  if (not nupfcands_2430_phi_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_2430_phi" << endl;
  }
  return nupfcands_2430_phi_;
}

const float &CMS3::nupfcands_30in_phi() {
  if (not nupfcands_30in_phi_isLoaded) {
    ...
    if (doprintusage) cout << "nupfcands_30in_phi" << endl;
  }
  return nupfcands_30in_phi_;
}

const float &CMS3::met_T1CHS_pt() {
  if (not met_T1CHS_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_pt" << endl;
  }
  return met_T1CHS_pt_;
}

const float &CMS3::met_T1CHS_phi() {
  if (not met_T1CHS_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_phi" << endl;
  }
  return met_T1CHS_phi_;
}

const float &CMS3::met_T1CHS_fromCORE_pt() {
  if (not met_T1CHS_fromCORE_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_fromCORE_pt" << endl;
  }
  return met_T1CHS_fromCORE_pt_;
}

const float &CMS3::met_T1CHS_fromCORE_phi() {
  if (not met_T1CHS_fromCORE_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_fromCORE_phi" << endl;
  }
...
const float &CMS3::met_T1CHS_miniAOD_CORE_pt() {
  if (not met_T1CHS_miniAOD_CORE_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_miniAOD_CORE_pt" << endl;
  }
...
const float &CMS3::met_T1CHS_miniAOD_CORE_phi() {
  if (not met_T1CHS_miniAOD_CORE_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_miniAOD_CORE_phi" << endl;
  }
...
const float &CMS3::met_T1CHS_miniAOD_CORE_up_pt() {
  if (not met_T1CHS_miniAOD_CORE_up_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_miniAOD_CORE_up_pt" << endl;
  }
...
const float &CMS3::met_T1CHS_miniAOD_CORE_up_phi() {
  if (not met_T1CHS_miniAOD_CORE_up_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_miniAOD_CORE_up_phi" << endl;
  }
...
const float &CMS3::met_T1CHS_miniAOD_CORE_dn_pt() {
  if (not met_T1CHS_miniAOD_CORE_dn_pt_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_miniAOD_CORE_dn_pt" << endl;
  }
...
const float &CMS3::met_T1CHS_miniAOD_CORE_dn_phi() {
  if (not met_T1CHS_miniAOD_CORE_dn_phi_isLoaded) {
    ...
    if (doprintusage) cout << "met_T1CHS_miniAOD_CORE_dn_phi" << endl;
  }
  return met_T1CHS_miniAOD_CORE_dn_phi_;
}

const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::decayedphoton_lep1_p4() {
  if (not decayedphoton_lep1_p4_isLoaded) {
    ...
    if (doprintusage) cout << "decayedphoton_lep1_p4" << endl;
  }
  return *decayedphoton_lep1_p4_;
}

const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::decayedphoton_lep2_p4() {
  if (not decayedphoton_lep2_p4_isLoaded) {
    ...
    if (doprintusage) cout << "decayedphoton_lep2_p4" << endl;
  }
  return *decayedphoton_lep2_p4_;
}

const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &CMS3::decayedphoton_bosn_p4() {
  if (not decayedphoton_bosn_p4_isLoaded) {
    ...
    if (doprintusage) cout << "decayedphoton_bosn_p4" << endl;
  }
  return *decayedphoton_bosn_p4_;
}

const float &CMS3::decayedphoton_mt2() {
  if (not decayedphoton_mt2_isLoaded) {
    ...
    if (doprintusage) cout << "decayedphoton_mt2" << endl;
  }
  return decayedphoton_mt2_;
}

const int &CMS3::hyp_type() {
  if (not hyp_type_isLoaded) {
    ...
    if (doprintusage) cout << "hyp_type" << endl;
  }
  return hyp_type_;
}

const int &CMS3::evt_type() {
  if (not evt_type_isLoaded) {
    ...
    if (doprintusage) cout << "evt_type" << endl;
  }
  return evt_type_;
}

const int &CMS3::mass_gluino() {
  if (not mass_gluino_isLoaded) {
    ...
    if (doprintusage) cout << "mass_gluino" << endl;
  }
  return mass_gluino_;
}

const int &CMS3::mass_LSP() {
  if (not mass_LSP_isLoaded) {
    ...
    if (doprintusage) cout << "mass_LSP" << endl;
  }
  return mass_LSP_;
}

const int &CMS3::mass_chi() {
  if (not mass_chi_isLoaded) {
    ...
    if (doprintusage) cout << "mass_chi" << endl;
  }
  return mass_chi_;
}

const float &CMS3::isrboost() {
  if (not isrboost_isLoaded) {
    ...
    if (doprintusage) cout << "isrboost" << endl;
  }
  return isrboost_;
}

const int &CMS3::isr_njets() {
  if (not isr_njets_isLoaded) {
    ...
    if (doprintusage) cout << "isr_njets" << endl;
  }
  return isr_njets_;
}

const float &CMS3::isr_weight() {
  if (not isr_weight_isLoaded) {
    ...
    if (doprintusage) cout << "isr_weight" << endl;
  }
  return isr_weight_;
}

const float &CMS3::isr_unc() {
  if (not isr_unc_isLoaded) {
    ...
    if (doprintusage) cout << "isr_unc" << endl;
  }
  return isr_unc_;
}

const vector<float> &CMS3::weightsf_lepid() {
  if (not weightsf_lepid_isLoaded) {
    ...
    if (doprintusage) cout << "weightsf_lepid" << endl;
  }
  return *weightsf_lepid_;
}

const vector<float> &CMS3::weightsf_lepiso() {
  if (not weightsf_lepiso_isLoaded) {
    ...
    if (doprintusage) cout << "weightsf_lepiso" << endl;
  }
  return *weightsf_lepiso_;
}

const vector<float> &CMS3::weightsf_lepip() {
  if (not weightsf_lepip_isLoaded) {
    ...
    if (doprintusage) cout << "weightsf_lepip" << endl;
  }
  return *weightsf_lepip_;
}

const vector<float> &CMS3::weightsf_lepreco() {
  if (not weightsf_lepreco_isLoaded) {
    ...
    if (doprintusage) cout << "weightsf_lepreco" << endl;
  }
  return *weightsf_lepreco_;
}

const vector<float> &CMS3::weightsf_lepconv() {
  if (not weightsf_lepconv_isLoaded) {
    ...
    if (doprintusage) cout << "weightsf_lepconv" << endl;
  }
  return *weightsf_lepconv_;
}

const vector<float> &CMS3::weightsf_lepid_FS() {
  if (not weightsf_lepid_FS_isLoaded) {
    ...
    if (doprintusage) cout << "weightsf_lepid_FS" << endl;
  }
  return *weightsf_lepid_FS_;
}

const vector<float> &CMS3::weightsf_lepiso_FS() {
  if (not weightsf_lepiso_FS_isLoaded) {
    ...
    if (doprintusage) cout << "weightsf_lepiso_FS" << endl;
  }
  return *weightsf_lepiso_FS_;
}

const vector<float> &CMS3::weightsf_lepip_FS() {
  if (not weightsf_lepip_FS_isLoaded) {
    ...
    if (doprintusage) cout << "weightsf_lepip_FS" << endl;
  }
  return *weightsf_lepip_FS_;
}

const float &CMS3::weight_fr_r1_f1() {
  if (not weight_fr_r1_f1_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r1_f1" << endl;
  }
  return weight_fr_r1_f1_;
}

const float &CMS3::weight_fr_r1_f2() {
  if (not weight_fr_r1_f2_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r1_f2" << endl;
  }
  return weight_fr_r1_f2_;
}

const float &CMS3::weight_fr_r1_f0p5() {
  if (not weight_fr_r1_f0p5_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r1_f0p5" << endl;
  }
  return weight_fr_r1_f0p5_;
}

const float &CMS3::weight_fr_r2_f1() {
  if (not weight_fr_r2_f1_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r2_f1" << endl;
  }
  return weight_fr_r2_f1_;
}

const float &CMS3::weight_fr_r2_f2() {
  if (not weight_fr_r2_f2_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r2_f2" << endl;
  }
  return weight_fr_r2_f2_;
}

const float &CMS3::weight_fr_r2_f0p5() {
  if (not weight_fr_r2_f0p5_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r2_f0p5" << endl;
  }
  return weight_fr_r2_f0p5_;
}

const float &CMS3::weight_fr_r0p5_f1() {
  if (not weight_fr_r0p5_f1_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r0p5_f1" << endl;
  }
  return weight_fr_r0p5_f1_;
}

const float &CMS3::weight_fr_r0p5_f2() {
  if (not weight_fr_r0p5_f2_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r0p5_f2" << endl;
  }
  return weight_fr_r0p5_f2_;
}

const float &CMS3::weight_fr_r0p5_f0p5() {
  if (not weight_fr_r0p5_f0p5_isLoaded) {
    ...
    if (doprintusage) cout << "weight_fr_r0p5_f0p5" << endl;
  }
  return weight_fr_r0p5_f0p5_;
}

const float &CMS3::weight_pdf_up() {
  if (not weight_pdf_up_isLoaded) {
    ...
    if (doprintusage) cout << "weight_pdf_up" << endl;
  }
  return weight_pdf_up_;
}

const float &CMS3::weight_pdf_down() {
  if (not weight_pdf_down_isLoaded) {
    ...
    if (doprintusage) cout << "weight_pdf_down" << endl;
  }
  return weight_pdf_down_;
}

const float &CMS3::weight_alphas_down() {
  if (not weight_alphas_down_isLoaded) {
    ...
    if (doprintusage) cout << "weight_alphas_down" << endl;
  }
  return weight_alphas_down_;
}

const float &CMS3::weight_alphas_up() {
  if (not weight_alphas_up_isLoaded) {
    ...
    if (doprintusage) cout << "weight_alphas_up" << endl;
  }
...
const int &HLT_CaloJet500_NoJetID() { return cms3.HLT_CaloJet500_NoJetID(); }
const int &HLT_ECALHT800_NoJetID() { return cms3.HLT_ECALHT800_NoJetID(); }
const bool &HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton() { return cms3.HLT_Photon22_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton() { return cms3.HLT_Photon30_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton() { return cms3.HLT_Photon36_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton() { return cms3.HLT_Photon50_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton() { return cms3.HLT_Photon75_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton() { return cms3.HLT_Photon90_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton() { return cms3.HLT_Photon120_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton() { return cms3.HLT_Photon165_R9Id90_HE10_IsoM_matchedtophoton(); }
const bool &HLT_Photon165_HE10_matchedtophoton() { return cms3.HLT_Photon165_HE10_matchedtophoton(); }
...
const int &nVetoEl_relIso03EAless01() { return cms3.nVetoEl_relIso03EAless01(); }
const int &nVetoEl_relIso03EAless02() { return cms3.nVetoEl_relIso03EAless02(); }
const int &nVetoEl_relIso03EAless03() { return cms3.nVetoEl_relIso03EAless03(); }
const int &nVetoEl_relIso03EAless04() { return cms3.nVetoEl_relIso03EAless04(); }
const int &nVetoMu_relIso03EAless01() { return cms3.nVetoMu_relIso03EAless01(); }
const int &nVetoMu_relIso03EAless02() { return cms3.nVetoMu_relIso03EAless02(); }
const int &nVetoMu_relIso03EAless03() { return cms3.nVetoMu_relIso03EAless03(); }
const int &nVetoMu_relIso03EAless04() { return cms3.nVetoMu_relIso03EAless04(); }
...
const vector<float> &lep_bdt1() { return cms3.lep_bdt1(); }
const vector<float> &lep_bdt2() { return cms3.lep_bdt2(); }
const vector<float> &lep_bdt3() { return cms3.lep_bdt3(); }
const vector<int> &lep_3ch_agree() { return cms3.lep_3ch_agree(); }
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &lep_closest_jet_p4() { return cms3.lep_closest_jet_p4(); }
...
const vector<float> &lep_miniRelIsoCMS3_EA() { return cms3.lep_miniRelIsoCMS3_EA(); }
const vector<float> &lep_miniRelIsoCMS3_EAv2() { return cms3.lep_miniRelIsoCMS3_EAv2(); }
const vector<float> &lep_miniRelIsoCMS3_DB() { return cms3.lep_miniRelIsoCMS3_DB(); }
const vector<int> &lep_isTriggerSafenoIso_v1() { return cms3.lep_isTriggerSafenoIso_v1(); }
const vector<int> &lep_isTriggerSafenoIso_v2() { return cms3.lep_isTriggerSafenoIso_v2(); }
const vector<int> &lep_isTriggerSafe_v1() { return cms3.lep_isTriggerSafe_v1(); }
const vector<int> &lep_isTriggerSafe_v2() { return cms3.lep_isTriggerSafe_v2(); }
const vector<int> &lep_pass_POG_loose_noiso() { return cms3.lep_pass_POG_loose_noiso(); }
const vector<int> &lep_pass_POG_medium_noiso() { return cms3.lep_pass_POG_medium_noiso(); }
const vector<int> &lep_pass_POG_tight_noiso() { return cms3.lep_pass_POG_tight_noiso(); }
...
const vector<int> &lep_pass_VVV_cutbased_veto_noiso_noip() { return cms3.lep_pass_VVV_cutbased_veto_noiso_noip(); }
const vector<int> &lep_pass_VVV_cutbased_veto_bak1() { return cms3.lep_pass_VVV_cutbased_veto_bak1(); }
const vector<int> &lep_pass_VVV_cutbased_veto_noiso_bak1() { return cms3.lep_pass_VVV_cutbased_veto_noiso_bak1(); }
const vector<int> &lep_pass_VVV_cutbased_veto_noiso_noip_bak1() { return cms3.lep_pass_VVV_cutbased_veto_noiso_noip_bak1(); }
...
const vector<int> &lep_pass_VVV_MVAbased_tight_noiso() { return cms3.lep_pass_VVV_MVAbased_tight_noiso(); }
const vector<int> &lep_pass_VVV_MVAbased_tight() { return cms3.lep_pass_VVV_MVAbased_tight(); }
const vector<int> &lep_pass_VVV_baseline() { return cms3.lep_pass_VVV_baseline(); }
const int &nlep_VVV_cutbased_veto() { return cms3.nlep_VVV_cutbased_veto(); }
const int &nlep_VVV_cutbased_veto_noiso() { return cms3.nlep_VVV_cutbased_veto_noiso(); }
const int &nlep_VVV_cutbased_veto_noiso_noip() { return cms3.nlep_VVV_cutbased_veto_noiso_noip(); }
const int &nlep_VVV_cutbased_veto_bak1() { return cms3.nlep_VVV_cutbased_veto_bak1(); }
const int &nlep_VVV_cutbased_veto_noiso_bak1() { return cms3.nlep_VVV_cutbased_veto_noiso_bak1(); }
const int &nlep_VVV_cutbased_veto_noiso_noip_bak1() { return cms3.nlep_VVV_cutbased_veto_noiso_noip_bak1(); }
const int &nlep_VVV_cutbased_fo() { return cms3.nlep_VVV_cutbased_fo(); }
const int &nlep_VVV_cutbased_fo_noiso() { return cms3.nlep_VVV_cutbased_fo_noiso(); }
const int &nlep_VVV_cutbased_tight_noiso() { return cms3.nlep_VVV_cutbased_tight_noiso(); }
const int &nlep_VVV_cutbased_tight() { return cms3.nlep_VVV_cutbased_tight(); }
const int &nlep_VVV_MVAbased_tight_noiso() { return cms3.nlep_VVV_MVAbased_tight_noiso(); }
const int &nlep_VVV_MVAbased_tight() { return cms3.nlep_VVV_MVAbased_tight(); }
const int &nlep_VVV_baseline() { return cms3.nlep_VVV_baseline(); }
const vector<int> &lep_pdgId() { return cms3.lep_pdgId(); }
const vector<int> &lep_mc_Id() { return cms3.lep_mc_Id(); }
...
const vector<float> &lep_r9() { return cms3.lep_r9(); }
...
const vector<float> &lep_exp_innerlayers() { return cms3.lep_exp_innerlayers(); }
const vector<float> &lep_exp_outerlayers() { return cms3.lep_exp_outerlayers(); }
const vector<int> &lep_nlayers() { return cms3.lep_nlayers(); }
const vector<int> &lep_type() { return cms3.lep_type(); }
const vector<int> &lep_validHits() { return cms3.lep_validHits(); }
const vector<float> &lep_dEtaIn_e() { return cms3.lep_dEtaIn_e(); }
const vector<float> &lep_dEtaOut_e() { return cms3.lep_dEtaOut_e(); }
const vector<float> &lep_dPhiIn_e() { return cms3.lep_dPhiIn_e(); }
const vector<float> &lep_ecalEnergy_e() { return cms3.lep_ecalEnergy_e(); }
const vector<float> &lep_ecalEnergyError_e() { return cms3.lep_ecalEnergyError_e(); }
const vector<float> &lep_ecalPFClusterIso_e() { return cms3.lep_ecalPFClusterIso_e(); }
const vector<float> &lep_eOverPIn_e() { return cms3.lep_eOverPIn_e(); }
const vector<float> &lep_hcalPFClusterIso_e() { return cms3.lep_hcalPFClusterIso_e(); }
const vector<float> &lep_hOverE_e() { return cms3.lep_hOverE_e(); }
const vector<float> &lep_scSeedEta_e() { return cms3.lep_scSeedEta_e(); }
const vector<float> &lep_sigmaIEtaIEta_full5x5_e() { return cms3.lep_sigmaIEtaIEta_full5x5_e(); }
const vector<float> &lep_tkIso_e() { return cms3.lep_tkIso_e(); }
const vector<int> &lep_goodGlb_m() { return cms3.lep_goodGlb_m(); }
const vector<int> &lep_isGlobal_m() { return cms3.lep_isGlobal_m(); }
const vector<int> &lep_isTracker_m() { return cms3.lep_isTracker_m(); }
const vector<int> &lep_gfit_ndof_m() { return cms3.lep_gfit_ndof_m(); }
const vector<float> &lep_chi2LocalPosition_m() { return cms3.lep_chi2LocalPosition_m(); }
const vector<float> &lep_gfit_chi2_m() { return cms3.lep_gfit_chi2_m(); }
const vector<int> &lep_gfit_validSTAHits_m() { return cms3.lep_gfit_validSTAHits_m(); }
const vector<int> &lep_numberOfMatchedStations_m() { return cms3.lep_numberOfMatchedStations_m(); }
const vector<int> &lep_pid_PFMuon_m() { return cms3.lep_pid_PFMuon_m(); }
const vector<float> &lep_segmCompatibility_m() { return cms3.lep_segmCompatibility_m(); }
const vector<float> &lep_trkKink_m() { return cms3.lep_trkKink_m(); }
const vector<int> &lep_validPixelHits_m() { return cms3.lep_validPixelHits_m(); }
...
const int &nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_veto_bak1() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_veto_bak1(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_bak1() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_bak1(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip_bak1() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_veto_noiso_noip_bak1(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_fo() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_fo(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_fo_noiso() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_fo_noiso(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_tight_noiso() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_tight_noiso(); }
const int &nisoTrack_mt2_cleaned_VVV_cutbased_tight() { return cms3.nisoTrack_mt2_cleaned_VVV_cutbased_tight(); }
const int &nisoTrack_mt2_cleaned_VVV_MVAbased_tight_noiso() { return cms3.nisoTrack_mt2_cleaned_VVV_MVAbased_tight_noiso(); }
const int &nisoTrack_mt2_cleaned_VVV_MVAbased_tight() { return cms3.nisoTrack_mt2_cleaned_VVV_MVAbased_tight(); }
const int &nisoTrack_mt2_cleaned_VVV_baseline() { return cms3.nisoTrack_mt2_cleaned_VVV_baseline(); }
const int &nisoTrack_stop() { return cms3.nisoTrack_stop(); }
...
const vector<float> &gamma_hOverE_online() { return cms3.gamma_hOverE_online(); }
const vector<int> &gamma_idCutBased() { return cms3.gamma_idCutBased(); }
const vector<float> &gamma_ecpfclusiso() { return cms3.gamma_ecpfclusiso(); }
const vector<float> &gamma_hcpfclusiso() { return cms3.gamma_hcpfclusiso(); }
const vector<float> &gamma_hollowtkiso03() { return cms3.gamma_hollowtkiso03(); }
const vector<int> &gamma_genIsPromptFinalState() { return cms3.gamma_genIsPromptFinalState(); }
...
const vector<int> &genPart_isp6status3() { return cms3.genPart_isp6status3(); }
...
const vector<int> &genLep_isp6status3() { return cms3.genLep_isp6status3(); }
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &highPtPFcands_p4() { return cms3.highPtPFcands_p4(); }
const vector<float> &highPtPFcands_dz() { return cms3.highPtPFcands_dz(); }
const vector<int> &highPtPFcands_pdgId() { return cms3.highPtPFcands_pdgId(); }
const float &ht() { return cms3.ht(); }
const float &ht_up() { return cms3.ht_up(); }
const float &ht_dn() { return cms3.ht_dn(); }
const float &metsig_unofficial() { return cms3.metsig_unofficial(); }
const float &metsig_unofficial_up() { return cms3.metsig_unofficial_up(); }
const float &metsig_unofficial_dn() { return cms3.metsig_unofficial_dn(); }
const float &mt_lep1() { return cms3.mt_lep1(); }
const float &mt2() { return cms3.mt2(); }
const float &mt2_up() { return cms3.mt2_up(); }
const float &mt2_dn() { return cms3.mt2_dn(); }
const float &mt2j() { return cms3.mt2j(); }
const float &mt2b() { return cms3.mt2b(); }
const float &mt2b_up() { return cms3.mt2b_up(); }
const float &mt2b_dn() { return cms3.mt2b_dn(); }
const float &mt2_genmet() { return cms3.mt2_genmet(); }
const float &mt2b_genmet() { return cms3.mt2b_genmet(); }
const float &mjj_mindphi() { return cms3.mjj_mindphi(); }
const float &mjj() { return cms3.mjj(); }
const float &mbb_csv() { return cms3.mbb_csv(); }
const float &mbb_bpt() { return cms3.mbb_bpt(); }
const float &dphi_jj() { return cms3.dphi_jj(); }
const float &dphi_ll() { return cms3.dphi_ll(); }
const float &sum_mlb() { return cms3.sum_mlb(); }
const float &deta_jj() { return cms3.deta_jj(); }
const float &dR_jj() { return cms3.dR_jj(); }
const float &dphi_metj1() { return cms3.dphi_metj1(); }
const float &dphi_metj2() { return cms3.dphi_metj2(); }
const float &dphi_genmetj1() { return cms3.dphi_genmetj1(); }
const float &dphi_genmetj2() { return cms3.dphi_genmetj2(); }
const float &mjj_mindphi_up() { return cms3.mjj_mindphi_up(); }
const float &mjj_up() { return cms3.mjj_up(); }
const float &mbb_csv_up() { return cms3.mbb_csv_up(); }
const float &mbb_bpt_up() { return cms3.mbb_bpt_up(); }
const float &dphi_jj_up() { return cms3.dphi_jj_up(); }
const float &dphi_ll_up() { return cms3.dphi_ll_up(); }
const float &sum_mlb_up() { return cms3.sum_mlb_up(); }
const float &deta_jj_up() { return cms3.deta_jj_up(); }
const float &dR_jj_up() { return cms3.dR_jj_up(); }
const float &dphi_metj1_up() { return cms3.dphi_metj1_up(); }
const float &dphi_metj2_up() { return cms3.dphi_metj2_up(); }
const float &mjj_mindphi_dn() { return cms3.mjj_mindphi_dn(); }
const float &mjj_dn() { return cms3.mjj_dn(); }
const float &mbb_csv_dn() { return cms3.mbb_csv_dn(); }
const float &mbb_bpt_dn() { return cms3.mbb_bpt_dn(); }
const float &dphi_jj_dn() { return cms3.dphi_jj_dn(); }
const float &dphi_ll_dn() { return cms3.dphi_ll_dn(); }
const float &sum_mlb_dn() { return cms3.sum_mlb_dn(); }
const float &deta_jj_dn() { return cms3.deta_jj_dn(); }
const float &dR_jj_dn() { return cms3.dR_jj_dn(); }
const float &dphi_metj1_dn() { return cms3.dphi_metj1_dn(); }
const float &dphi_metj2_dn() { return cms3.dphi_metj2_dn(); }
...
const float &chpfcands_0013_pt() { return cms3.chpfcands_0013_pt(); }
const float &chpfcands_1316_pt() { return cms3.chpfcands_1316_pt(); }
const float &chpfcands_1624_pt() { return cms3.chpfcands_1624_pt(); }
const float &chpfcands_2430_pt() { return cms3.chpfcands_2430_pt(); }
const float &chpfcands_30in_pt() { return cms3.chpfcands_30in_pt(); }
const float &phpfcands_0013_pt() { return cms3.phpfcands_0013_pt(); }
const float &phpfcands_1316_pt() { return cms3.phpfcands_1316_pt(); }
const float &phpfcands_1624_pt() { return cms3.phpfcands_1624_pt(); }
const float &phpfcands_2430_pt() { return cms3.phpfcands_2430_pt(); }
const float &phpfcands_30in_pt() { return cms3.phpfcands_30in_pt(); }
const float &nupfcands_0013_pt() { return cms3.nupfcands_0013_pt(); }
const float &nupfcands_1316_pt() { return cms3.nupfcands_1316_pt(); }
const float &nupfcands_1624_pt() { return cms3.nupfcands_1624_pt(); }
const float &nupfcands_2430_pt() { return cms3.nupfcands_2430_pt(); }
const float &nupfcands_30in_pt() { return cms3.nupfcands_30in_pt(); }
const float &chpfcands_0013_sumet() { return cms3.chpfcands_0013_sumet(); }
const float &chpfcands_1316_sumet() { return cms3.chpfcands_1316_sumet(); }
const float &chpfcands_1624_sumet() { return cms3.chpfcands_1624_sumet(); }
const float &chpfcands_2430_sumet() { return cms3.chpfcands_2430_sumet(); }
const float &chpfcands_30in_sumet() { return cms3.chpfcands_30in_sumet(); }
const float &phpfcands_0013_sumet() { return cms3.phpfcands_0013_sumet(); }
const float &phpfcands_1316_sumet() { return cms3.phpfcands_1316_sumet(); }
const float &phpfcands_1624_sumet() { return cms3.phpfcands_1624_sumet(); }
const float &phpfcands_2430_sumet() { return cms3.phpfcands_2430_sumet(); }
const float &phpfcands_30in_sumet() { return cms3.phpfcands_30in_sumet(); }
const float &nupfcands_0013_sumet() { return cms3.nupfcands_0013_sumet(); }
const float &nupfcands_1316_sumet() { return cms3.nupfcands_1316_sumet(); }
const float &nupfcands_1624_sumet() { return cms3.nupfcands_1624_sumet(); }
const float &nupfcands_2430_sumet() { return cms3.nupfcands_2430_sumet(); }
const float &nupfcands_30in_sumet() { return cms3.nupfcands_30in_sumet(); }
const float &chpfcands_0013_phi() { return cms3.chpfcands_0013_phi(); }
const float &chpfcands_1316_phi() { return cms3.chpfcands_1316_phi(); }
const float &chpfcands_1624_phi() { return cms3.chpfcands_1624_phi(); }
const float &chpfcands_2430_phi() { return cms3.chpfcands_2430_phi(); }
const float &chpfcands_30in_phi() { return cms3.chpfcands_30in_phi(); }
const float &phpfcands_0013_phi() { return cms3.phpfcands_0013_phi(); }
const float &phpfcands_1316_phi() { return cms3.phpfcands_1316_phi(); }
const float &phpfcands_1624_phi() { return cms3.phpfcands_1624_phi(); }
const float &phpfcands_2430_phi() { return cms3.phpfcands_2430_phi(); }
const float &phpfcands_30in_phi() { return cms3.phpfcands_30in_phi(); }
const float &nupfcands_0013_phi() { return cms3.nupfcands_0013_phi(); }
const float &nupfcands_1316_phi() { return cms3.nupfcands_1316_phi(); }
const float &nupfcands_1624_phi() { return cms3.nupfcands_1624_phi(); }
const float &nupfcands_2430_phi() { return cms3.nupfcands_2430_phi(); }
const float &nupfcands_30in_phi() { return cms3.nupfcands_30in_phi(); }
...
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_lep1_p4() { return cms3.decayedphoton_lep1_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_lep2_p4() { return cms3.decayedphoton_lep2_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &decayedphoton_bosn_p4() { return cms3.decayedphoton_bosn_p4(); }
const float &decayedphoton_mt2() { return cms3.decayedphoton_mt2(); }
const int &hyp_type() { return cms3.hyp_type(); }
const int &evt_type() { return cms3.evt_type(); }
const int &mass_gluino() { return cms3.mass_gluino(); }
const int &mass_LSP() { return cms3.mass_LSP(); }
const int &mass_chi() { return cms3.mass_chi(); }
...
const float &weight_fr_r1_f1() { return cms3.weight_fr_r1_f1(); }
const float &weight_fr_r1_f2() { return cms3.weight_fr_r1_f2(); }
const float &weight_fr_r1_f0p5() { return cms3.weight_fr_r1_f0p5(); }
const float &weight_fr_r2_f1() { return cms3.weight_fr_r2_f1(); }
const float &weight_fr_r2_f2() { return cms3.weight_fr_r2_f2(); }
const float &weight_fr_r2_f0p5() { return cms3.weight_fr_r2_f0p5(); }
const float &weight_fr_r0p5_f1() { return cms3.weight_fr_r0p5_f1(); }
const float &weight_fr_r0p5_f2() { return cms3.weight_fr_r0p5_f2(); }
const float &weight_fr_r0p5_f0p5() { return cms3.weight_fr_r0p5_f0p5(); }
const float &weight_pdf_up() { return cms3.weight_pdf_up(); }
const float &weight_pdf_down() { return cms3.weight_pdf_down(); }
const float &weight_alphas_down() { return cms3.weight_alphas_down(); }
const float &weight_alphas_up() { return cms3.weight_alphas_up(); }
